...
public class EditorPalette extends JPanel
{
	...
	public void addTemplate(final String name, ImageIcon icon, mxCell cell)
	{
		final mxGraphTransferable t = new mxGraphTransferable(
				new Object[] { cell }, (mxGeometry) cell.getGeometry().clone());
	 ...
	 * @param eventName
	 * @param listener
	 * @see com.mxgraph.util.mxEventSource#addListener(java.lang.String, com.mxgraph.util.mxEventSource.mxEventListener)
	 */
	...
	/**
	 * @param listener
	 * @see com.mxgraph.util.mxEventSource#removeListener(com.mxgraph.util.mxEventSource.mxEventListener)
	 */
	 ...
	 * @param eventName
	 * @param listener
	 * @see com.mxgraph.util.mxEventSource#removeListener(java.lang.String, com.mxgraph.util.mxEventSource.mxEventListener)
	 */
	public void removeListener(String eventName, mxEventListener listener)
	{
