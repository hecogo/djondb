/* 
 * $Id: EditorRuler.java,v 1.1 2008/09/26 14:47:41 gaudenz Exp $
		...
		DropTargetListener
{
	 ...
	 * 
	 */
	protected transient mxEventListener repaintHandler = new mxEventListener()
	{
	...
	{
		Dimension dim = graphComponent.getControl().getPreferredSize();
