...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Release.mk dist/Release/GNU-Linux-x86/libworkflow.so
...
${OBJECTDIR}/engine/tokenfacade.o: nbproject/Makefile-${CND_CONF}.mk engine/tokenfacade.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/engine/tokenfacade.o engine/tokenfacade.cpp

${OBJECTDIR}/metadata/masterentity.o: nbproject/Makefile-${CND_CONF}.mk metadata/masterentity.cpp 
	${MKDIR} -p ${OBJECTDIR}/metadata
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/metadata/masterentity.o metadata/masterentity.cpp

${OBJECTDIR}/engine/processinstance.o: nbproject/Makefile-${CND_CONF}.mk engine/processinstance.cpp 
	${MKDIR} -p ${OBJECTDIR}/engine
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/engine/processinstance.o engine/processinstance.cpp

${OBJECTDIR}/engine/token.o: nbproject/Makefile-${CND_CONF}.mk engine/token.cpp 
	${MKDIR} -p ${OBJECTDIR}/engine
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/engine/token.o engine/token.cpp

${OBJECTDIR}/workflowcontroller.o: nbproject/Makefile-${CND_CONF}.mk workflowcontroller.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/workflowcontroller.o workflowcontroller.cpp

${OBJECTDIR}/wfruntime.o: nbproject/Makefile-${CND_CONF}.mk wfruntime.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/wfruntime.o wfruntime.cpp

${OBJECTDIR}/metadata.o: nbproject/Makefile-${CND_CONF}.mk metadata.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/metadata.o metadata.cpp
...
.clean-conf:
	${RM} -r build/Release
	${RM} dist/Release/GNU-Linux-x86/libworkflow.so
