...
LDLIBSOPTIONS=/home/cross/workspace/jaguar/jaguar/jaguar-client/jaguarui/dist/Debug/GNU-Linux-x86/libjaguarui.so.1.0.0 /home/cross/workspace/jaguar/jaguar/libs/libnetworkcommon.so
...
.build-conf: ${BUILD_SUBPROJECTS} nbproject/qt-${CONF}.mk
	${MAKE} -f nbproject/qt-${CONF}.mk dist/Debug/GNU-Linux-x86/libjclientgen.so.1.0.0
