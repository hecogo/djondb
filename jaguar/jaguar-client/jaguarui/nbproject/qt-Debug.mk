...
# Generated by qmake (2.01a) (Qt 4.6.2) on: Mon May 17 18:26:53 2010
...
SOURCES       = ui/freeformlayout.cpp \
		...
		ui/TextSimple.cpp \
		ui/MenuItem.cpp moc_TextSimple.cpp \
		moc_MainWindow.cpp \
		moc_ScreenBase.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) nbproject/build/Debug/GNU-Linux-x86/jaguarui1.0.0/ && $(COPY_FILE) --parents jaguarui.h ui/freeformlayout.h ui/TextSimple.h ui/MainWindow.h ui/label.h ui/GenericControl.h ScreenBase.h ui/CurrentDateTime.h ui/MenuItem.h nbproject/build/Debug/GNU-Linux-x86/jaguarui1.0.0/ && $(COPY_FILE) --parents ui/freeformlayout.cpp ScreenBase.cpp ui/CurrentDateTime.cpp jaguarui.cpp ui/MainWindow.cpp ui/label.cpp ui/GenericControl.cpp ui/TextSimple.cpp ui/MenuItem.cpp nbproject/build/Debug/GNU-Linux-x86/jaguarui1.0.0/ && $(COPY_FILE) --parents ui/MainWindow.ui ui/CurrentDateTime.ui nbproject/build/Debug/GNU-Linux-x86/jaguarui1.0.0/ && (cd `dirname nbproject/build/Debug/GNU-Linux-x86/jaguarui1.0.0` && $(TAR) jaguarui1.0.0.tar jaguarui1.0.0 && $(COMPRESS) jaguarui1.0.0.tar) && $(MOVE) `dirname nbproject/build/Debug/GNU-Linux-x86/jaguarui1.0.0`/jaguarui1.0.0.tar.gz . && $(DEL_FILE) -r nbproject/build/Debug/GNU-Linux-x86/jaguarui1.0.0
...
moc_ScreenBase.cpp: ui/freeformlayout.h \
		ui/GenericControl.h \
		ScreenBase.h
...
build/Debug/GNU-Linux-x86/ScreenBase.o: ScreenBase.cpp ScreenBase.h \
		ui/freeformlayout.h \
		ui/GenericControl.h
...
build/Debug/GNU-Linux-x86/jaguarui.o: jaguarui.cpp jaguarui.h \
		ScreenBase.h \
		ui/freeformlayout.h \
		ui/GenericControl.h \
		ui/MenuItem.h
