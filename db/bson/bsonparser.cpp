...
//    }
     ...
     //
     lxr        = JSONGrammarLexerNew(input);      // CLexerNew is generated by ANTLR
     ...
     //
     psr        = JSONGrammarParserNew(tstream);  // CParserNew is generated by ANTLR3
   ...
   struct BSONStruct {
     ...
     BSONStruct* s = (BSONStruct*)psr->start_point(psr);
     ...
     while (s != NULL) {
         ...
         switch (type) {
             case 1:
                  val = (int*)value;
                  obj->add(std::string(name), *val);
                  break;
             case 2:
                  val2 = (float*)value;
                  obj->add(std::string(name), *val2);
                  break;
             case 3:
                  val3 = (char*)value;
                  obj->add(std::string(name), val3);
                  break;
         }
         s = s->next;
     }
