...
namespace swig {  
  ...
  */
  ...
  namespace swig {
    template <>  struct traits<BSONObj > {
      typedef pointer_category category;
      static const char* type_name() { return"BSONObj"; }
    };
  }
...
namespace swig {
  ...
  namespace swig {
	...
	return traits_from_stdseq<std::vector<T> >::from(vec);
      ...
      namespace swig {
	template <>  struct traits<std::vector<BSONObj*, std::allocator< BSONObj * > > > {
	  typedef value_category category;
	  static const char* type_name() {
	    return "std::vector<" "BSONObj" " *," "std::allocator< BSONObj * >" " >";
	  }
	};
      }
    
SWIGINTERN std::vector< BSONObj *,std::allocator< BSONObj * > > *std_vector_Sl_BSONObj_Sm__Sg__dup(std::vector< BSONObj * > *self){
      return new std::vector<BSONObj*,std::allocator< BSONObj * > >(*self);
    }
SWIGINTERN VALUE std_vector_Sl_BSONObj_Sm__Sg__inspect(std::vector< BSONObj * > *self){
      std::vector<BSONObj*,std::allocator< BSONObj * > >::const_iterator i = self->begin();
      std::vector<BSONObj*,std::allocator< BSONObj * > >::const_iterator e = self->end();
      const char *type_name = swig::type_name< std::vector<BSONObj*,std::allocator< BSONObj * > > >();
      ...
      for ( ; i != e; ++i, comma = true )
	{
	  ...
	  tmp = swig::from< std::vector<BSONObj*,std::allocator< BSONObj * > >::value_type >( *i );
	  tmp = rb_inspect( tmp );
...
SWIGINTERN VALUE std_vector_Sl_BSONObj_Sm__Sg__to_a(std::vector< BSONObj * > *self){
      std::vector<BSONObj*,std::allocator< BSONObj * > >::const_iterator i = self->begin();
      std::vector<BSONObj*,std::allocator< BSONObj * > >::const_iterator e = self->end();
...
SWIGINTERN VALUE std_vector_Sl_BSONObj_Sm__Sg__to_s(std::vector< BSONObj * > *self){
      std::vector<BSONObj*,std::allocator< BSONObj * > >::iterator i = self->begin();
      std::vector<BSONObj*,std::allocator< BSONObj * > >::iterator e = self->end();
...
SWIGINTERN VALUE std_vector_Sl_BSONObj_Sm__Sg__slice(std::vector< BSONObj * > *self,std::vector< BSONObj * >::difference_type i,std::vector< BSONObj * >::difference_type j){
	if ( j <= 0 ) return Qnil;
	...
	VALUE r = Qnil;
	try {
	  r = swig::from< const std::vector<BSONObj*,std::allocator< BSONObj * > >* >( swig::getslice(self, i, j) );
	}
...
SWIGINTERN std::vector< BSONObj *,std::allocator< BSONObj * > > *std_vector_Sl_BSONObj_Sm__Sg__each(std::vector< BSONObj * > *self){
	if ( !rb_block_given_p() )
	...
	for ( ; i != e; ++i )
	  {
	    r = swig::from< std::vector<BSONObj*,std::allocator< BSONObj * > >::value_type >(*i);
	    rb_yield(r);
	  }
	
	return self;
      }
SWIGINTERN std::vector< BSONObj *,std::allocator< BSONObj * > > *std_vector_Sl_BSONObj_Sm__Sg__select(std::vector< BSONObj * > *self){
      if ( !rb_block_given_p() )
	rb_raise( rb_eArgError, "no block given" );

      std::vector<BSONObj*,std::allocator< BSONObj * > >* r = new std::vector<BSONObj*,std::allocator< BSONObj * > >;
      std::vector<BSONObj*,std::allocator< BSONObj * > >::const_iterator i = self->begin();
      std::vector<BSONObj*,std::allocator< BSONObj * > >::const_iterator e = self->end();
      for ( ; i != e; ++i )
	{
	  VALUE v = swig::from< std::vector<BSONObj*,std::allocator< BSONObj * > >::value_type >(*i);
	  if ( RTEST( rb_yield(v) ) )
	    self->insert( r->end(), *i);
	}
...
SWIGINTERN std::vector< BSONObj *,std::allocator< BSONObj * > > *std_vector_Sl_BSONObj_Sm__Sg__reject_bang(std::vector< BSONObj * > *self){
      if ( !rb_block_given_p() )
	rb_raise( rb_eArgError, "no block given" );
      ...
      for ( ; i != e; )
	{
	  VALUE r = swig::from< std::vector<BSONObj*,std::allocator< BSONObj * > >::value_type >(*i);
	  if ( RTEST( rb_yield(r) ) ) {
	    self->erase(i++);
            e = self->end();
	  } else {
...
SWIGINTERN VALUE std_vector_Sl_BSONObj_Sm__Sg__delete_at(std::vector< BSONObj * > *self,std::vector< BSONObj * >::difference_type i){
      VALUE r = Qnil;
      try {
	std::vector<BSONObj*,std::allocator< BSONObj * > >::iterator at = swig::getpos(self, i);
	r = swig::from< std::vector<BSONObj*,std::allocator< BSONObj * > >::value_type >( *(at) );
	self->erase(at); 
      }
      catch (std::out_of_range)
	{
...
SWIGINTERN VALUE std_vector_Sl_BSONObj_Sm__Sg____delete2__(std::vector< BSONObj * > *self,std::vector< BSONObj * >::value_type const &i){
      VALUE r = Qnil;
      return r;
    }
SWIGINTERN VALUE std_vector_Sl_BSONObj_Sm__Sg__pop(std::vector< BSONObj * > *self){
      if (self->empty()) return Qnil;
      std::vector<BSONObj*,std::allocator< BSONObj * > >::value_type x = self->back();
      self->pop_back();
      return swig::from< std::vector<BSONObj*,std::allocator< BSONObj * > >::value_type >( x );
    }
SWIGINTERN std::vector< BSONObj * >::value_type const std_vector_Sl_BSONObj_Sm__Sg__push(std::vector< BSONObj * > *self,std::vector< BSONObj * >::value_type const &e){
      self->push_back( e );
      return e;
    }
SWIGINTERN std::vector< BSONObj *,std::allocator< BSONObj * > > *std_vector_Sl_BSONObj_Sm__Sg__reject(std::vector< BSONObj * > *self){
      if ( !rb_block_given_p() )
	rb_raise( rb_eArgError, "no block given" );
      ...
      std::remove_copy_if( self->begin(), self->end(),              
			   std::back_inserter(*r),
			   swig::yield< std::vector<BSONObj*,std::allocator< BSONObj * > >::value_type >() );
      return r;
    }
SWIGINTERN VALUE std_vector_Sl_BSONObj_Sm__Sg__at(std::vector< BSONObj * > const *self,std::vector< BSONObj * >::difference_type i){
      VALUE r = Qnil;
      try {
	r = swig::from< std::vector<BSONObj*,std::allocator< BSONObj * > >::value_type >( *(swig::cgetpos(self, i)) );
      }
      catch( std::out_of_range )
	{
	}
...
SWIGINTERN VALUE std_vector_Sl_BSONObj_Sm__Sg____getitem____SWIG_0(std::vector< BSONObj * > const *self,std::vector< BSONObj * >::difference_type i,std::vector< BSONObj * >::difference_type j){
      if ( j <= 0 ) return Qnil;
      std::size_t len = self->size();
      if ( i < 0 ) i = len - i;
...
SWIGINTERN VALUE std_vector_Sl_BSONObj_Sm__Sg____getitem____SWIG_1(std::vector< BSONObj * > const *self,std::vector< BSONObj * >::difference_type i){
      VALUE r = Qnil;
      try {
	r = swig::from< std::vector<BSONObj*,std::allocator< BSONObj * > >::value_type >( *(swig::cgetpos(self, i)) );
      }
...
SWIGINTERN VALUE std_vector_Sl_BSONObj_Sm__Sg____getitem____SWIG_2(std::vector< BSONObj * > const *self,VALUE i){
      if ( rb_obj_is_kind_of( i, rb_cRange ) == Qfalse )
	{
      ...
      return swig::from< std::vector<BSONObj*,std::allocator< BSONObj * > >* >( swig::getslice(self, s, e+1) );
    }
SWIGINTERN VALUE std_vector_Sl_BSONObj_Sm__Sg____setitem____SWIG_0(std::vector< BSONObj * > *self,std::vector< BSONObj * >::difference_type i,std::vector< BSONObj * >::value_type const &x){
	std::size_t len = self->size();
	if ( i < 0 ) i = len - i;
...
SWIGINTERN VALUE std_vector_Sl_BSONObj_Sm__Sg____setitem____SWIG_1(std::vector< BSONObj * > *self,std::vector< BSONObj * >::difference_type i,std::vector< BSONObj * >::difference_type j,std::vector< BSONObj *,std::allocator< BSONObj * > > const &v){
	...
	j = len-1;
      ...
      r = swig::from< const std::vector<BSONObj*,std::allocator< BSONObj * > >* >( &v );
      return r;
    }
SWIGINTERN VALUE std_vector_Sl_BSONObj_Sm__Sg__shift(std::vector< BSONObj * > *self){
      if (self->empty()) return Qnil;
      std::vector<BSONObj*,std::allocator< BSONObj * > >::value_type x = self->front();
...
SWIGINTERN std::vector< BSONObj *,std::allocator< BSONObj * > > *std_vector_Sl_BSONObj_Sm__Sg__insert__SWIG_0(std::vector< BSONObj * > *self,std::vector< BSONObj * >::difference_type pos,int argc,VALUE *argv,...){
      std::size_t len = self->size();
      std::size_t   i = swig::check_index( pos, len, true );
      std::vector<BSONObj*,std::allocator< BSONObj * > >::iterator start;

      VALUE elem = argv[0];
      int idx = 0;
      try {
	std::vector<BSONObj*,std::allocator< BSONObj * > >::value_type val = swig::as<std::vector<BSONObj*,std::allocator< BSONObj * > >::value_type>( elem, true );
	if ( i >= len ) {
	  self->resize(i-1, val);
	  return self;
	}
	...
	for ( ++idx; idx < argc; ++idx )
	  {
	    elem = argv[idx];
	    val = swig::as<std::vector<BSONObj*,std::allocator< BSONObj * > >::value_type>( elem );
	    self->insert( start++, val );
	  }
      ...
      catch( std::invalid_argument )
	{
	  rb_raise( rb_eArgError, "%s",
		    Ruby_Format_TypeError( "", 
					   swig::type_name<std::vector<BSONObj*,std::allocator< BSONObj * > >::value_type>(),
...
SWIGINTERN std::vector< BSONObj *,std::allocator< BSONObj * > > *std_vector_Sl_BSONObj_Sm__Sg__unshift(std::vector< BSONObj * > *self,int argc,VALUE *argv,...){
      for ( int idx = argc-1; idx >= 0; --idx )
	{
	  std::vector<BSONObj*,std::allocator< BSONObj * > >::iterator start = self->begin();
	  VALUE elem = argv[idx];
	  try {
	    std::vector<BSONObj*,std::allocator< BSONObj * > >::value_type val = swig::as<std::vector<BSONObj*,std::allocator< BSONObj * > >::value_type>( elem, true );
	    self->insert( start, val );
...
swig_class SwigClassBSONObjVectorPtr;
...
*/
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_dup(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::vector< BSONObj *,std::allocator< BSONObj * > > *result = 0 ;
  VALUE vresult = Qnil;
  
  if ((argc < 0) || (argc > 0)) {
    rb_raise(rb_eArgError, "wrong # of arguments(%d for 0)",argc); SWIG_fail;
  }
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< BSONObj * > *","dup", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< BSONObj * > * >(argp1);
  result = (std::vector< BSONObj *,std::allocator< BSONObj * > > *)std_vector_Sl_BSONObj_Sm__Sg__dup(arg1);
  vresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, SWIG_POINTER_OWN |  0 );
  return vresult;
fail:
  return Qnil;
}
...
*/
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_inspect(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  VALUE result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< BSONObj * > *","inspect", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< BSONObj * > * >(argp1);
  result = (VALUE)std_vector_Sl_BSONObj_Sm__Sg__inspect(arg1);
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
Convert BSONObjVectorPtr to an Array.
*/
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_to_a(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  VALUE result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< BSONObj * > *","to_a", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< BSONObj * > * >(argp1);
  result = (VALUE)std_vector_Sl_BSONObj_Sm__Sg__to_a(arg1);
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
*/
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_to_s(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  VALUE result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< BSONObj * > *","to_s", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< BSONObj * > * >(argp1);
  result = (VALUE)std_vector_Sl_BSONObj_Sm__Sg__to_s(arg1);
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
Return a slice (portion of) the BSONObjVectorPtr.
*/
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_slice(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  std::vector< BSONObj * >::difference_type arg2 ;
  std::vector< BSONObj * >::difference_type arg3 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ptrdiff_t val2 ;
  int ecode2 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< BSONObj * > *","slice", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< BSONObj * > * >(argp1);
  ecode2 = SWIG_AsVal_ptrdiff_t(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "std::vector< BSONObj * >::difference_type","slice", 2, argv[0] ));
  } 
  arg2 = static_cast< std::vector< BSONObj * >::difference_type >(val2);
  ecode3 = SWIG_AsVal_ptrdiff_t(argv[1], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), Ruby_Format_TypeError( "", "std::vector< BSONObj * >::difference_type","slice", 3, argv[1] ));
  } 
  arg3 = static_cast< std::vector< BSONObj * >::difference_type >(val3);
  result = (VALUE)std_vector_Sl_BSONObj_Sm__Sg__slice(arg1,arg2,arg3);
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
Iterate thru each element in the BSONObjVectorPtr.  A block must be provided.
*/
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_each(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::vector< BSONObj *,std::allocator< BSONObj * > > *result = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< BSONObj * > *","each", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< BSONObj * > * >(argp1);
  result = (std::vector< BSONObj *,std::allocator< BSONObj * > > *)std_vector_Sl_BSONObj_Sm__Sg__each(arg1);
  vresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  return vresult;
fail:
  return Qnil;
}
...
Iterate thru each element in the BSONObjVectorPtr and select those that match a condition.  A block must be provided.
*/
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_select(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::vector< BSONObj *,std::allocator< BSONObj * > > *result = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< BSONObj * > *","select", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< BSONObj * > * >(argp1);
  result = (std::vector< BSONObj *,std::allocator< BSONObj * > > *)std_vector_Sl_BSONObj_Sm__Sg__select(arg1);
  vresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, SWIG_POINTER_OWN |  0 );
  return vresult;
fail:
  return Qnil;
...
Iterate thru each element in the BSONObjVectorPtr and reject those that fail a condition.  A block must be provided.  BSONObjVectorPtr is modified in place.
*/
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_rejectN___(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::vector< BSONObj *,std::allocator< BSONObj * > > *result = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< BSONObj * > *","reject_bang", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< BSONObj * > * >(argp1);
  result = (std::vector< BSONObj *,std::allocator< BSONObj * > > *)std_vector_Sl_BSONObj_Sm__Sg__reject_bang(arg1);
  vresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  return vresult;
fail:
  return Qnil;
...
*/
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_delete_at(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  std::vector< BSONObj * >::difference_type arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< BSONObj * > *","delete_at", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< BSONObj * > * >(argp1);
  ecode2 = SWIG_AsVal_ptrdiff_t(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "std::vector< BSONObj * >::difference_type","delete_at", 2, argv[0] ));
  } 
  arg2 = static_cast< std::vector< BSONObj * >::difference_type >(val2);
  result = (VALUE)std_vector_Sl_BSONObj_Sm__Sg__delete_at(arg1,arg2);
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr___delete2__(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< BSONObj * > *","__delete2__", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< BSONObj * > * >(argp1);
  res2 = SWIG_ConvertPtr(argv[0], &argp2, SWIGTYPE_p_BSONObj, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "std::vector< BSONObj * >::value_type","__delete2__", 2, argv[0] )); 
  }
  temp2 = reinterpret_cast< std::vector< BSONObj * >::value_type >(argp2);
  arg2 = reinterpret_cast< std::vector< BSONObj * >::value_type * >(&temp2);
  result = (VALUE)std_vector_Sl_BSONObj_Sm__Sg____delete2__(arg1,(BSONObj *const &)*arg2);
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
Remove and return element at the end of the BSONObjVectorPtr.
*/
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_pop(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  VALUE result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< BSONObj * > *","pop", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< BSONObj * > * >(argp1);
  result = (VALUE)std_vector_Sl_BSONObj_Sm__Sg__pop(arg1);
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
Add an element at the end of the BSONObjVectorPtr.
*/
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_push(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  std::vector< BSONObj * >::value_type *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  int res2 = 0 ;
  std::vector< BSONObj * >::value_type temp2 ;
  std::vector< BSONObj * >::value_type result;
  VALUE vresult = Qnil;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< BSONObj * > *","push", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< BSONObj * > * >(argp1);
  res2 = SWIG_ConvertPtr(argv[0], &argp2, SWIGTYPE_p_BSONObj, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "std::vector< BSONObj * >::value_type","push", 2, argv[0] )); 
  }
  temp2 = reinterpret_cast< std::vector< BSONObj * >::value_type >(argp2);
  arg2 = reinterpret_cast< std::vector< BSONObj * >::value_type * >(&temp2);
  result = (std::vector< BSONObj * >::value_type)std_vector_Sl_BSONObj_Sm__Sg__push(arg1,(BSONObj *const &)*arg2);
...
Iterate thru each element in the BSONObjVectorPtr and reject those that fail a condition returning a new BSONObjVectorPtr.  A block must be provided.
*/
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_reject(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::vector< BSONObj *,std::allocator< BSONObj * > > *result = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< BSONObj * > *","reject", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< BSONObj * > * >(argp1);
  result = (std::vector< BSONObj *,std::allocator< BSONObj * > > *)std_vector_Sl_BSONObj_Sm__Sg__reject(arg1);
  vresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, SWIG_POINTER_OWN |  0 );
  return vresult;
fail:
  return Qnil;
...
*/
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_at(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  std::vector< BSONObj * >::difference_type arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< BSONObj * > const *","at", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< BSONObj * > * >(argp1);
  ecode2 = SWIG_AsVal_ptrdiff_t(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "std::vector< BSONObj * >::difference_type","at", 2, argv[0] ));
  } 
  arg2 = static_cast< std::vector< BSONObj * >::difference_type >(val2);
  result = (VALUE)std_vector_Sl_BSONObj_Sm__Sg__at((std::vector< BSONObj * > const *)arg1,arg2);
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
*/
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr___getitem____SWIG_0(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  std::vector< BSONObj * >::difference_type arg2 ;
  std::vector< BSONObj * >::difference_type arg3 ;
  void *argp1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< BSONObj * > const *","__getitem__", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< BSONObj * > * >(argp1);
  ecode2 = SWIG_AsVal_ptrdiff_t(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "std::vector< BSONObj * >::difference_type","__getitem__", 2, argv[0] ));
  } 
  arg2 = static_cast< std::vector< BSONObj * >::difference_type >(val2);
  ecode3 = SWIG_AsVal_ptrdiff_t(argv[1], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), Ruby_Format_TypeError( "", "std::vector< BSONObj * >::difference_type","__getitem__", 3, argv[1] ));
  } 
  arg3 = static_cast< std::vector< BSONObj * >::difference_type >(val3);
  result = (VALUE)std_vector_Sl_BSONObj_Sm__Sg____getitem____SWIG_0((std::vector< BSONObj * > const *)arg1,arg2,arg3);
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr___getitem____SWIG_1(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  std::vector< BSONObj * >::difference_type arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  arg2 = static_cast< std::vector< BSONObj * >::difference_type >(val2);
  result = (VALUE)std_vector_Sl_BSONObj_Sm__Sg____getitem____SWIG_1((std::vector< BSONObj * > const *)arg1,arg2);
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr___getitem____SWIG_2(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  VALUE arg2 = (VALUE) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  arg1 = reinterpret_cast< std::vector< BSONObj * > * >(argp1);
  arg2 = argv[0];
  result = (VALUE)std_vector_Sl_BSONObj_Sm__Sg____getitem____SWIG_2((std::vector< BSONObj * > const *)arg1,arg2);
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
SWIGINTERN VALUE _wrap_BSONObjVectorPtr___getitem__(int nargs, VALUE *args, VALUE self) {
  int argc;
  VALUE argv[4];
  int ii;
  ...
  if (argc == 2) {
    int _v;
    int res = swig::asptr(argv[0], (std::vector<BSONObj*,std::allocator< BSONObj * > >**)(0));
    _v = SWIG_CheckState(res);
    if (_v) {
      {
        int res = SWIG_AsVal_ptrdiff_t(argv[1], NULL);
      ...
      if (_v) {
        return _wrap_BSONObjVectorPtr___getitem____SWIG_1(nargs, args, self);
      }
    }
  }
  if (argc == 2) {
    ...
    if (_v) {
      _v = (argv[1] != 0);
      if (_v) {
        return _wrap_BSONObjVectorPtr___getitem____SWIG_2(nargs, args, self);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          return _wrap_BSONObjVectorPtr___getitem____SWIG_0(nargs, args, self);
        }
      }
    }
  }
...
fail:
  Ruby_Format_OverloadedError( argc, 4, "__getitem__", 
    "    VALUE __getitem__(std::vector< BSONObj * >::difference_type i, std::vector< BSONObj * >::difference_type j)\n"
    "    VALUE __getitem__(std::vector< BSONObj * >::difference_type i)\n"
...
*/
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr___setitem____SWIG_0(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  std::vector< BSONObj * >::difference_type arg2 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< BSONObj * > *","__setitem__", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< BSONObj * > * >(argp1);
  ecode2 = SWIG_AsVal_ptrdiff_t(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "std::vector< BSONObj * >::difference_type","__setitem__", 2, argv[0] ));
  } 
  arg2 = static_cast< std::vector< BSONObj * >::difference_type >(val2);
  res3 = SWIG_ConvertPtr(argv[1], &argp3, SWIGTYPE_p_BSONObj, 0 |  0 );
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), Ruby_Format_TypeError( "", "std::vector< BSONObj * >::value_type","__setitem__", 3, argv[1] )); 
  }
  temp3 = reinterpret_cast< std::vector< BSONObj * >::value_type >(argp3);
  arg3 = reinterpret_cast< std::vector< BSONObj * >::value_type * >(&temp3);
  result = (VALUE)std_vector_Sl_BSONObj_Sm__Sg____setitem____SWIG_0(arg1,arg2,(BSONObj *const &)*arg3);
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr___setitem____SWIG_1(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  std::vector< BSONObj * >::difference_type arg2 ;
  std::vector< BSONObj * >::difference_type arg3 ;
  std::vector< BSONObj *,std::allocator< BSONObj * > > *arg4 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ptrdiff_t val2 ;
  int ecode2 = 0 ;
  ...
  ecode3 = SWIG_AsVal_ptrdiff_t(argv[1], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), Ruby_Format_TypeError( "", "std::vector< BSONObj * >::difference_type","__setitem__", 3, argv[1] ));
  } 
  arg3 = static_cast< std::vector< BSONObj * >::difference_type >(val3);
  {
    std::vector<BSONObj*,std::allocator< BSONObj * > > *ptr = (std::vector<BSONObj*,std::allocator< BSONObj * > > *)0;
    res4 = swig::asptr(argv[2], &ptr);
    if (!SWIG_IsOK(res4)) {
      SWIG_exception_fail(SWIG_ArgError(res4), Ruby_Format_TypeError( "", "std::vector< BSONObj *,std::allocator< BSONObj * > > const &","__setitem__", 4, argv[2] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::vector< BSONObj *,std::allocator< BSONObj * > > const &","__setitem__", 4, argv[2])); 
    }
    arg4 = ptr;
  }
  try {
    result = (VALUE)std_vector_Sl_BSONObj_Sm__Sg____setitem____SWIG_1(arg1,arg2,arg3,(std::vector< BSONObj *,std::allocator< BSONObj * > > const &)*arg4);
  }
...
SWIGINTERN VALUE _wrap_BSONObjVectorPtr___setitem__(int nargs, VALUE *args, VALUE self) {
  int argc;
  VALUE argv[5];
  int ii;
  ...
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        void *vptr = 0;
        int res = SWIG_ConvertPtr(argv[2], &vptr, SWIGTYPE_p_BSONObj, 0);
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_BSONObjVectorPtr___setitem____SWIG_0(nargs, args, self);
        }
      }
    }
  }
  if (argc == 4) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          int res = swig::asptr(argv[3], (std::vector<BSONObj*,std::allocator< BSONObj * > >**)(0));
          _v = SWIG_CheckState(res);
          if (_v) {
            return _wrap_BSONObjVectorPtr___setitem____SWIG_1(nargs, args, self);
          }
        }
      }
    }
...
fail:
  Ruby_Format_OverloadedError( argc, 5, "__setitem__", 
    "    VALUE __setitem__(std::vector< BSONObj * >::difference_type i, std::vector< BSONObj * >::value_type const &x)\n"
    "    VALUE __setitem__(std::vector< BSONObj * >::difference_type i, std::vector< BSONObj * >::difference_type j, std::vector< BSONObj *,std::allocator< BSONObj * > > const &v)\n");
...
Remove and return element at the beginning of the BSONObjVectorPtr.
*/
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_shift(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  VALUE result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< BSONObj * > *","shift", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< BSONObj * > * >(argp1);
  result = (VALUE)std_vector_Sl_BSONObj_Sm__Sg__shift(arg1);
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
Insert one or more new elements in the BSONObjVectorPtr.
*/
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_insert__SWIG_0(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  std::vector< BSONObj * >::difference_type arg2 ;
  int arg3 ;
  VALUE *arg4 = (VALUE *) 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< BSONObj * > *","insert", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< BSONObj * > * >(argp1);
  ecode2 = SWIG_AsVal_ptrdiff_t(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "std::vector< BSONObj * >::difference_type","insert", 2, argv[0] ));
  } 
  arg2 = static_cast< std::vector< BSONObj * >::difference_type >(val2);
  {
    arg3 = argc - 1;
  ...
  result = (std::vector< BSONObj *,std::allocator< BSONObj * > > *)std_vector_Sl_BSONObj_Sm__Sg__insert__SWIG_0(arg1,arg2,arg3,arg4,arg5);
  vresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  return vresult;
fail:
  return Qnil;
...
Add one or more elements at the beginning of the BSONObjVectorPtr.
*/
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_unshift(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  int arg2 ;
  VALUE *arg3 = (VALUE *) 0 ;
  void *arg4 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< BSONObj * > *","unshift", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< BSONObj * > * >(argp1);
  {
    arg2 = argc;
  ...
  result = (std::vector< BSONObj *,std::allocator< BSONObj * > > *)std_vector_Sl_BSONObj_Sm__Sg__unshift(arg1,arg2,arg3,arg4);
  vresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  return vresult;
fail:
  return Qnil;
...
SWIGINTERN VALUE
_wrap_new_BSONObjVectorPtr__SWIG_0(int argc, VALUE *argv, VALUE self) {
...
SWIGINTERN VALUE
_wrap_new_BSONObjVectorPtr__SWIG_1(int argc, VALUE *argv, VALUE self) {
  ...
  }
  {
    ...
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< BSONObj * > const &","std::vector<(p.BSONObj)>", 1, argv[0] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::vector< BSONObj * > const &","std::vector<(p.BSONObj)>", 1, argv[0])); 
    }
    arg1 = ptr;
  }
...
Check if the BSONObjVectorPtr is empty or not.
*/
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_emptyq___(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  bool result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< BSONObj * > const *","empty", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< BSONObj * > * >(argp1);
...
Size or Length of the BSONObjVectorPtr.
*/
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_size(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< BSONObj * > const *","size", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< BSONObj * > * >(argp1);
...
Clear BSONObjVectorPtr contents.
*/
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_clear(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< BSONObj * > *","clear", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< BSONObj * > * >(argp1);
  (arg1)->clear();
  return Qnil;
...
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_swap(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< BSONObj * > *","swap", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< BSONObj * > * >(argp1);
  res2 = SWIG_ConvertPtr(argv[0], &argp2, SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "std::vector< BSONObj * > &","swap", 2, argv[0] )); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::vector< BSONObj * > &","swap", 2, argv[0])); 
  }
  arg2 = reinterpret_cast< std::vector< BSONObj * > * >(argp2);
  (arg1)->swap(*arg2);
  return Qnil;
fail:
  return Qnil;
...
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_get_allocator(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  SwigValueWrapper< std::allocator< BSONObj * > > result;
  VALUE vresult = Qnil;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< BSONObj * > const *","get_allocator", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< BSONObj * > * >(argp1);
  result = ((std::vector< BSONObj * > const *)arg1)->get_allocator();
  vresult = SWIG_NewPointerObj((new std::vector< BSONObj * >::allocator_type(static_cast< const std::vector< BSONObj * >::allocator_type& >(result))), SWIGTYPE_p_std__allocatorT_BSONObj_p_t, SWIG_POINTER_OWN |  0 );
  return vresult;
fail:
  return Qnil;
}
...
Return an iterator to the beginning of the BSONObjVectorPtr.
*/
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_begin(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< BSONObj * > *","begin", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< BSONObj * > * >(argp1);
  result = (arg1)->begin();
  vresult = SWIG_NewPointerObj(swig::make_nonconst_iterator(static_cast< const std::vector< BSONObj * >::iterator & >(result),
      self),
...
Return an iterator to past the end of the BSONObjVectorPtr.
*/
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_end(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::vector< BSONObj * >::iterator result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< BSONObj * > *","end", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< BSONObj * > * >(argp1);
  result = (arg1)->end();
  vresult = SWIG_NewPointerObj(swig::make_nonconst_iterator(static_cast< const std::vector< BSONObj * >::iterator & >(result),
...
Return a reverse iterator to the beginning (the end) of the BSONObjVectorPtr.
*/
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_rbegin(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::vector< BSONObj * >::reverse_iterator result;
  VALUE vresult = Qnil;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< BSONObj * > *","rbegin", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< BSONObj * > * >(argp1);
  result = (arg1)->rbegin();
  vresult = SWIG_NewPointerObj(swig::make_nonconst_iterator(static_cast< const std::vector< BSONObj * >::reverse_iterator & >(result),
      self),
    swig::Iterator::descriptor(),SWIG_POINTER_OWN);
  return vresult;
fail:
...
Return a reverse iterator to past the end (past the beginning) of the BSONObjVectorPtr.
*/
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_rend(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::vector< BSONObj * >::reverse_iterator result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< BSONObj * > *","rend", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< BSONObj * > * >(argp1);
  result = (arg1)->rend();
  vresult = SWIG_NewPointerObj(swig::make_nonconst_iterator(static_cast< const std::vector< BSONObj * >::reverse_iterator & >(result),
...
SWIGINTERN VALUE
_wrap_new_BSONObjVectorPtr__SWIG_2(int argc, VALUE *argv, VALUE self) {
  ...
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), Ruby_Format_TypeError( "", "std::vector< BSONObj * >::size_type","std::vector<(p.BSONObj)>", 1, argv[0] ));
  } 
  arg1 = static_cast< std::vector< BSONObj * >::size_type >(val1);
...
Resize the size of the BSONObjVectorPtr.
*/
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_resize__SWIG_0(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< BSONObj * > *","resize", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< BSONObj * > * >(argp1);
  ecode2 = SWIG_AsVal_size_t(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "std::vector< BSONObj * >::size_type","resize", 2, argv[0] ));
  } 
  arg2 = static_cast< std::vector< BSONObj * >::size_type >(val2);
  (arg1)->resize(arg2);
  return Qnil;
fail:
  return Qnil;
...
Delete a portion of the BSONObjVectorPtr.
*/
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_erase__SWIG_0(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  std::vector< BSONObj * >::iterator arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< BSONObj * > *","erase", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< BSONObj * > * >(argp1);
  res2 = SWIG_ConvertPtr(argv[0], SWIG_as_voidptrptr(&iter2), swig::Iterator::descriptor(), 0);
  if (!SWIG_IsOK(res2) || !iter2) {
    SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), Ruby_Format_TypeError( "", "std::vector< BSONObj * >::iterator","erase", 2, argv[0] ));
  } else {
    swig::Iterator_T<std::vector< BSONObj * >::iterator > *iter_t = dynamic_cast<swig::Iterator_T<std::vector< BSONObj * >::iterator > *>(iter2);
    if (iter_t) {
...
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_erase__SWIG_1(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  std::vector< BSONObj * >::iterator arg2 ;
  std::vector< BSONObj * >::iterator arg3 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  swig::Iterator *iter2 = 0 ;
  int res2 ;
  ...
  if (!SWIG_IsOK(res3) || !iter3) {
    SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), Ruby_Format_TypeError( "", "std::vector< BSONObj * >::iterator","erase", 3, argv[1] ));
  } else {
    swig::Iterator_T<std::vector< BSONObj * >::iterator > *iter_t = dynamic_cast<swig::Iterator_T<std::vector< BSONObj * >::iterator > *>(iter3);
    if (iter_t) {
...
SWIGINTERN VALUE _wrap_BSONObjVectorPtr_erase(int nargs, VALUE *args, VALUE self) {
  int argc;
  VALUE argv[4];
  int ii;
  ...
  if (argc == 2) {
    ...
    if (_v) {
      ...
      _v = (SWIG_IsOK(res) && iter && (dynamic_cast<swig::Iterator_T<std::vector< BSONObj * >::iterator > *>(iter) != 0));
      if (_v) {
        return _wrap_BSONObjVectorPtr_erase__SWIG_0(nargs, args, self);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = (SWIG_IsOK(res) && iter && (dynamic_cast<swig::Iterator_T<std::vector< BSONObj * >::iterator > *>(iter) != 0));
        if (_v) {
          return _wrap_BSONObjVectorPtr_erase__SWIG_1(nargs, args, self);
        }
      }
    }
  }
...
fail:
  Ruby_Format_OverloadedError( argc, 4, "BSONObjVectorPtr.erase", 
    "    std::vector< BSONObj * >::iterator BSONObjVectorPtr.erase(std::vector< BSONObj * >::iterator pos)\n"
    "    std::vector< BSONObj * >::iterator BSONObjVectorPtr.erase(std::vector< BSONObj * >::iterator first, std::vector< BSONObj * >::iterator last)\n");
...
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_allocate(VALUE self) {
#else
  SWIGINTERN VALUE
  _wrap_BSONObjVectorPtr_allocate(int argc, VALUE *argv, VALUE self) {
#endif
    
    
    VALUE vresult = SWIG_NewClassInstance(self, SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t);
#ifndef HAVE_RB_DEFINE_ALLOC_FUNC
...
SWIGINTERN VALUE
_wrap_new_BSONObjVectorPtr__SWIG_3(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * >::size_type arg1 ;
  std::vector< BSONObj * >::value_type arg2 = (std::vector< BSONObj * >::value_type) 0 ;
  size_t val1 ;
  int ecode1 = 0 ;
  void *argp2 = 0 ;
  int res2 = 0 ;
  ...
  arg1 = static_cast< std::vector< BSONObj * >::size_type >(val1);
  res2 = SWIG_ConvertPtr(argv[1], &argp2,SWIGTYPE_p_BSONObj, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "std::vector< BSONObj * >::value_type","std::vector<(p.BSONObj)>", 2, argv[1] )); 
  }
  arg2 = reinterpret_cast< std::vector< BSONObj * >::value_type >(argp2);
  result = (std::vector< BSONObj * > *)new std::vector< BSONObj * >(arg1,arg2);
  DATA_PTR(self) = result;
  return self;
fail:
  return Qnil;
...
SWIGINTERN VALUE _wrap_new_BSONObjVectorPtr(int nargs, VALUE *args, VALUE self) {
  int argc;
  VALUE argv[2];
  int ii;
  ...
  if (argc == 0) {
    return _wrap_new_BSONObjVectorPtr__SWIG_0(nargs, args, self);
  }
  if (argc == 1) {
    int _v;
    {
    ...
    if (_v) {
      return _wrap_new_BSONObjVectorPtr__SWIG_2(nargs, args, self);
    }
  }
  if (argc == 1) {
    int _v;
    ...
    _v = SWIG_CheckState(res);
    if (_v) {
      return _wrap_new_BSONObjVectorPtr__SWIG_1(nargs, args, self);
    }
  }
  if (argc == 2) {
    int _v;
    ...
    if (_v) {
      void *vptr = 0;
      int res = SWIG_ConvertPtr(argv[1], &vptr, SWIGTYPE_p_BSONObj, 0);
      _v = SWIG_CheckState(res);
      if (_v) {
        return _wrap_new_BSONObjVectorPtr__SWIG_3(nargs, args, self);
      }
    }
  }
  
fail:
  Ruby_Format_OverloadedError( argc, 2, "BSONObjVectorPtr.new", 
    "    BSONObjVectorPtr.new()\n"
    "    BSONObjVectorPtr.new(std::vector< BSONObj * > const &)\n"
    "    BSONObjVectorPtr.new(std::vector< BSONObj * >::size_type size)\n"
    "    BSONObjVectorPtr.new(std::vector< BSONObj * >::size_type size, std::vector< BSONObj * >::value_type value)\n");
...
Return the first element in BSONObjVectorPtr.
*/
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_front(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::vector< BSONObj * >::value_type result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< BSONObj * > const *","front", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< BSONObj * > * >(argp1);
  result = (std::vector< BSONObj * >::value_type)((std::vector< BSONObj * > const *)arg1)->front();
  vresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_BSONObj, 0 |  0 );
  return vresult;
fail:
  return Qnil;
...
Return the last element in BSONObjVectorPtr.
*/
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_back(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::vector< BSONObj * >::value_type result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< BSONObj * > const *","back", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< BSONObj * > * >(argp1);
  result = (std::vector< BSONObj * >::value_type)((std::vector< BSONObj * > const *)arg1)->back();
  vresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_BSONObj, 0 |  0 );
  return vresult;
fail:
  return Qnil;
...
Assign a new BSONObjVectorPtr or portion of it.
*/
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_assign(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  std::vector< BSONObj * >::size_type arg2 ;
  std::vector< BSONObj * >::value_type arg3 = (std::vector< BSONObj * >::value_type) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  size_t val2 ;
  int ecode2 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< BSONObj * > *","assign", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< BSONObj * > * >(argp1);
  ecode2 = SWIG_AsVal_size_t(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "std::vector< BSONObj * >::size_type","assign", 2, argv[0] ));
  } 
  arg2 = static_cast< std::vector< BSONObj * >::size_type >(val2);
  res3 = SWIG_ConvertPtr(argv[1], &argp3,SWIGTYPE_p_BSONObj, 0 |  0 );
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), Ruby_Format_TypeError( "", "std::vector< BSONObj * >::value_type","assign", 3, argv[1] )); 
  }
  arg3 = reinterpret_cast< std::vector< BSONObj * >::value_type >(argp3);
...
*/
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_resize__SWIG_1(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  std::vector< BSONObj * >::size_type arg2 ;
  std::vector< BSONObj * >::value_type arg3 = (std::vector< BSONObj * >::value_type) 0 ;
  void *argp1 = 0 ;
  ...
  res3 = SWIG_ConvertPtr(argv[1], &argp3,SWIGTYPE_p_BSONObj, 0 |  0 );
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), Ruby_Format_TypeError( "", "std::vector< BSONObj * >::value_type","resize", 3, argv[1] )); 
  }
  arg3 = reinterpret_cast< std::vector< BSONObj * >::value_type >(argp3);
...
SWIGINTERN VALUE _wrap_BSONObjVectorPtr_resize(int nargs, VALUE *args, VALUE self) {
  int argc;
  VALUE argv[4];
  int ii;
  ...
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_BSONObjVectorPtr_resize__SWIG_0(nargs, args, self);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_BSONObjVectorPtr_resize__SWIG_1(nargs, args, self);
        }
      }
    }
  }
...
fail:
  Ruby_Format_OverloadedError( argc, 4, "BSONObjVectorPtr.resize", 
    "    void BSONObjVectorPtr.resize(std::vector< BSONObj * >::size_type new_size)\n"
    "    void BSONObjVectorPtr.resize(std::vector< BSONObj * >::size_type new_size, std::vector< BSONObj * >::value_type x)\n");
...
*/
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_insert__SWIG_1(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  std::vector< BSONObj * >::iterator arg2 ;
  std::vector< BSONObj * >::value_type arg3 = (std::vector< BSONObj * >::value_type) 0 ;
  void *argp1 = 0 ;
  ...
  res2 = SWIG_ConvertPtr(argv[0], SWIG_as_voidptrptr(&iter2), swig::Iterator::descriptor(), 0);
  if (!SWIG_IsOK(res2) || !iter2) {
    SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), Ruby_Format_TypeError( "", "std::vector< BSONObj * >::iterator","insert", 2, argv[0] ));
  } else {
    swig::Iterator_T<std::vector< BSONObj * >::iterator > *iter_t = dynamic_cast<swig::Iterator_T<std::vector< BSONObj * >::iterator > *>(iter2);
    if (iter_t) {
      arg2 = iter_t->get_current();
  ...
  res3 = SWIG_ConvertPtr(argv[1], &argp3,SWIGTYPE_p_BSONObj, 0 |  0 );
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), Ruby_Format_TypeError( "", "std::vector< BSONObj * >::value_type","insert", 3, argv[1] )); 
  }
  arg3 = reinterpret_cast< std::vector< BSONObj * >::value_type >(argp3);
...
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_insert__SWIG_2(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  std::vector< BSONObj * >::iterator arg2 ;
  std::vector< BSONObj * >::size_type arg3 ;
  std::vector< BSONObj * >::value_type arg4 = (std::vector< BSONObj * >::value_type) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  swig::Iterator *iter2 = 0 ;
  int res2 ;
  ...
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), Ruby_Format_TypeError( "", "std::vector< BSONObj * >::size_type","insert", 3, argv[1] ));
  } 
  arg3 = static_cast< std::vector< BSONObj * >::size_type >(val3);
  res4 = SWIG_ConvertPtr(argv[2], &argp4,SWIGTYPE_p_BSONObj, 0 |  0 );
  if (!SWIG_IsOK(res4)) {
    SWIG_exception_fail(SWIG_ArgError(res4), Ruby_Format_TypeError( "", "std::vector< BSONObj * >::value_type","insert", 4, argv[2] )); 
  }
  arg4 = reinterpret_cast< std::vector< BSONObj * >::value_type >(argp4);
...
SWIGINTERN VALUE _wrap_BSONObjVectorPtr_insert(int nargs, VALUE *args, VALUE self) {
  int argc;
  VALUE argv[5];
  int ii;
  ...
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_BSONObjVectorPtr_insert__SWIG_1(nargs, args, self);
        }
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          if (argc <= 3) {
            return _wrap_BSONObjVectorPtr_insert__SWIG_0(nargs, args, self);
          }
          return _wrap_BSONObjVectorPtr_insert__SWIG_0(nargs, args, self);
        }
      }
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          ...
          _v = SWIG_CheckState(res);
          if (_v) {
            return _wrap_BSONObjVectorPtr_insert__SWIG_2(nargs, args, self);
          }
        }
      }
    }
...
fail:
  Ruby_Format_OverloadedError( argc, 5, "insert", 
    "    void insert(std::vector< BSONObj * >::difference_type pos, int argc, VALUE *argv, ...)\n"
    "    void insert(std::vector< BSONObj * >::iterator pos, std::vector< BSONObj * >::value_type x)\n"
    "    void insert(std::vector< BSONObj * >::iterator pos, std::vector< BSONObj * >::size_type n, std::vector< BSONObj * >::value_type x)\n");
...
Reserve memory in the BSONObjVectorPtr for a number of elements.
*/
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_reserve(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  std::vector< BSONObj * >::size_type arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< BSONObj * > *","reserve", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< BSONObj * > * >(argp1);
  ecode2 = SWIG_AsVal_size_t(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "std::vector< BSONObj * >::size_type","reserve", 2, argv[0] ));
  } 
  arg2 = static_cast< std::vector< BSONObj * >::size_type >(val2);
  (arg1)->reserve(arg2);
  return Qnil;
...
Reserved capacity of the BSONObjVectorPtr.
*/
SWIGINTERN VALUE
_wrap_BSONObjVectorPtr_capacity(int argc, VALUE *argv, VALUE self) {
  std::vector< BSONObj * > *arg1 = (std::vector< BSONObj * > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::vector< BSONObj * >::size_type result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< BSONObj * > const *","capacity", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< BSONObj * > * >(argp1);
...
SWIGINTERN void
free_std_vector_Sl_BSONObj_Sm__Sg_(std::vector< BSONObj * > *arg1) {
    delete arg1;
}
...
swig_class SwigClassBSONArrayObj;

SWIGINTERN VALUE
_wrap_new_BSONArrayObj__SWIG_0(int argc, VALUE *argv, VALUE self) {
...
SWIGINTERN void
free_BSONArrayObj(BSONArrayObj *arg1) {
    delete arg1;
}

#ifdef HAVE_RB_DEFINE_ALLOC_FUNC
SWIGINTERN VALUE
_wrap_BSONArrayObj_allocate(VALUE self) {
#else
  SWIGINTERN VALUE
  _wrap_BSONArrayObj_allocate(int argc, VALUE *argv, VALUE self) {
#endif
    
    
    VALUE vresult = SWIG_NewClassInstance(self, SWIGTYPE_p_BSONArrayObj);
#ifndef HAVE_RB_DEFINE_ALLOC_FUNC
    rb_obj_call_init(vresult, argc, argv);
#endif
    return vresult;
...
SWIGINTERN VALUE
_wrap_new_BSONArrayObj__SWIG_1(int argc, VALUE *argv, VALUE self) {
  BSONArrayObj *arg1 = 0 ;
  void *argp1 ;
  int res1 = 0 ;
  BSONArrayObj *result = 0 ;
  ...
  res1 = SWIG_ConvertPtr(argv[0], &argp1, SWIGTYPE_p_BSONArrayObj,  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "BSONArrayObj const &","BSONArrayObj", 1, argv[0] )); 
  }
  if (!argp1) {
    SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "BSONArrayObj const &","BSONArrayObj", 1, argv[0])); 
  }
  arg1 = reinterpret_cast< BSONArrayObj * >(argp1);
...
SWIGINTERN VALUE _wrap_new_BSONArrayObj(int nargs, VALUE *args, VALUE self) {
  int argc;
  VALUE argv[1];
  int ii;
  ...
  if (argc == 0) {
    return _wrap_new_BSONArrayObj__SWIG_0(nargs, args, self);
  }
  if (argc == 1) {
    int _v;
    void *vptr = 0;
    int res = SWIG_ConvertPtr(argv[0], &vptr, SWIGTYPE_p_BSONArrayObj, 0);
    _v = SWIG_CheckState(res);
    if (_v) {
      return _wrap_new_BSONArrayObj__SWIG_1(nargs, args, self);
    }
  }
  
fail:
  Ruby_Format_OverloadedError( argc, 1, "BSONArrayObj.new", 
    "    BSONArrayObj.new()\n"
    "    BSONArrayObj.new(BSONArrayObj const &orig)\n");
...
Size or Length of the BSONArrayObj.
*/
SWIGINTERN VALUE
_wrap_BSONArrayObj_length(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_BSONArrayObj, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "BSONArrayObj const *","length", 1, self )); 
  }
  arg1 = reinterpret_cast< BSONArrayObj * >(argp1);
...
SWIGINTERN VALUE
_wrap_BSONArrayObj_add(int argc, VALUE *argv, VALUE self) {
  BSONArrayObj *arg1 = (BSONArrayObj *) 0 ;
  BSONObj *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_BSONArrayObj, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "BSONArrayObj *","add", 1, self )); 
  }
  arg1 = reinterpret_cast< BSONArrayObj * >(argp1);
  res2 = SWIG_ConvertPtr(argv[0], &argp2, SWIGTYPE_p_BSONObj,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "BSONObj const &","add", 2, argv[0] )); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "BSONObj const &","add", 2, argv[0])); 
  }
  arg2 = reinterpret_cast< BSONObj * >(argp2);
...
SWIGINTERN VALUE
_wrap_BSONArrayObj_get(int argc, VALUE *argv, VALUE self) {
  BSONArrayObj *arg1 = (BSONArrayObj *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_BSONArrayObj, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "BSONArrayObj const *","get", 1, self )); 
  }
  arg1 = reinterpret_cast< BSONArrayObj * >(argp1);
...
SWIGINTERN VALUE
_wrap_BSONArrayObj_toChar(int argc, VALUE *argv, VALUE self) {
  BSONArrayObj *arg1 = (BSONArrayObj *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  char *result = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_BSONArrayObj, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "BSONArrayObj const *","toChar", 1, self )); 
  }
  arg1 = reinterpret_cast< BSONArrayObj * >(argp1);
...
Iterate thru each element in the BSONArrayObj and select those that match a condition.  A block must be provided.
*/
SWIGINTERN VALUE
_wrap_BSONArrayObj_select(int argc, VALUE *argv, VALUE self) {
  BSONArrayObj *arg1 = (BSONArrayObj *) 0 ;
  char *arg2 = (char *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_BSONArrayObj, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "BSONArrayObj const *","select", 1, self )); 
  }
  arg1 = reinterpret_cast< BSONArrayObj * >(argp1);
  res2 = SWIG_AsCharPtrAndSize(argv[0], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "char const *","select", 2, argv[0] ));
  }
...
Return an iterator to the beginning of the BSONArrayObj.
*/
SWIGINTERN VALUE
_wrap_BSONArrayObj_begin(int argc, VALUE *argv, VALUE self) {
  BSONArrayObj *arg1 = (BSONArrayObj *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  SwigValueWrapper< std::vector< BSONObj *,std::allocator< BSONObj * > >::iterator > result;
  VALUE vresult = Qnil;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_BSONArrayObj, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "BSONArrayObj *","begin", 1, self )); 
  }
  arg1 = reinterpret_cast< BSONArrayObj * >(argp1);
  result = (arg1)->begin();
  vresult = SWIG_NewPointerObj(swig::make_nonconst_iterator(static_cast< const BSONArrayObj::iterator & >(result),
      self),
    swig::Iterator::descriptor(),SWIG_POINTER_OWN);
  return vresult;
fail:
...
Return an iterator to past the end of the BSONArrayObj.
*/
SWIGINTERN VALUE
_wrap_BSONArrayObj_end(int argc, VALUE *argv, VALUE self) {
  BSONArrayObj *arg1 = (BSONArrayObj *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  SwigValueWrapper< std::vector< BSONObj *,std::allocator< BSONObj * > >::iterator > result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_BSONArrayObj, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "BSONArrayObj *","end", 1, self )); 
  }
  arg1 = reinterpret_cast< BSONArrayObj * >(argp1);
  result = (arg1)->end();
  vresult = SWIG_NewPointerObj(swig::make_nonconst_iterator(static_cast< const BSONArrayObj::iterator & >(result),
...
swig_class SwigClassBSONObj;

SWIGINTERN VALUE
_wrap_new_BSONObj__SWIG_0(int argc, VALUE *argv, VALUE self) {
  BSONObj *result = 0 ;
...
#ifdef HAVE_RB_DEFINE_ALLOC_FUNC
SWIGINTERN VALUE
_wrap_BSONObj_allocate(VALUE self) {
#else
  SWIGINTERN VALUE
  _wrap_BSONObj_allocate(int argc, VALUE *argv, VALUE self) {
#endif
    
    
    VALUE vresult = SWIG_NewClassInstance(self, SWIGTYPE_p_BSONObj);
#ifndef HAVE_RB_DEFINE_ALLOC_FUNC
    rb_obj_call_init(vresult, argc, argv);
#endif
    return vresult;
...
SWIGINTERN VALUE
_wrap_new_BSONObj__SWIG_1(int argc, VALUE *argv, VALUE self) {
  BSONObj *arg1 = 0 ;
  void *argp1 ;
  int res1 = 0 ;
  BSONObj *result = 0 ;
  ...
  res1 = SWIG_ConvertPtr(argv[0], &argp1, SWIGTYPE_p_BSONObj,  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "BSONObj const &","BSONObj", 1, argv[0] )); 
  }
  if (!argp1) {
    SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "BSONObj const &","BSONObj", 1, argv[0])); 
  }
  arg1 = reinterpret_cast< BSONObj * >(argp1);
...
SWIGINTERN VALUE _wrap_new_BSONObj(int nargs, VALUE *args, VALUE self) {
  int argc;
  VALUE argv[1];
  int ii;
  ...
  if (argc == 0) {
    return _wrap_new_BSONObj__SWIG_0(nargs, args, self);
  }
  if (argc == 1) {
    int _v;
    void *vptr = 0;
    int res = SWIG_ConvertPtr(argv[0], &vptr, SWIGTYPE_p_BSONObj, 0);
    _v = SWIG_CheckState(res);
    if (_v) {
      return _wrap_new_BSONObj__SWIG_1(nargs, args, self);
    }
  }
  
fail:
  Ruby_Format_OverloadedError( argc, 1, "BSONObj.new", 
    "    BSONObj.new()\n"
    "    BSONObj.new(BSONObj const &orig)\n");
...
SWIGINTERN void
free_BSONObj(BSONObj *arg1) {
    delete arg1;
}

SWIGINTERN VALUE
_wrap_BSONObj_add__SWIG_0(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_BSONObj, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "BSONObj *","add", 1, self )); 
  }
  arg1 = reinterpret_cast< BSONObj * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    ...
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), Ruby_Format_TypeError( "", "std::string","add", 2, argv[0] )); 
    }
    arg2 = *ptr;
...
SWIGINTERN VALUE
_wrap_BSONObj_add__SWIG_1(int argc, VALUE *argv, VALUE self) {
  BSONObj *arg1 = (BSONObj *) 0 ;
  std::string arg2 ;
  double arg3 ;
  void *argp1 = 0 ;
  ...
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), Ruby_Format_TypeError( "", "double","add", 3, argv[1] ));
  } 
...
SWIGINTERN VALUE
_wrap_BSONObj_add__SWIG_2(int argc, VALUE *argv, VALUE self) {
  BSONObj *arg1 = (BSONObj *) 0 ;
  std::string arg2 ;
  long arg3 ;
  void *argp1 = 0 ;
  ...
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), Ruby_Format_TypeError( "", "long","add", 3, argv[1] ));
  } 
...
SWIGINTERN VALUE
_wrap_BSONObj_add__SWIG_3(int argc, VALUE *argv, VALUE self) {
  BSONObj *arg1 = (BSONObj *) 0 ;
  std::string arg2 ;
  __LONG64 arg3 ;
  void *argp1 = 0 ;
  ...
  {
    res3 = SWIG_ConvertPtr(argv[1], &argp3, SWIGTYPE_p___LONG64,  0 );
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), Ruby_Format_TypeError( "", "__LONG64","add", 3, argv[1] )); 
    }  
    if (!argp3) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "__LONG64","add", 3, argv[1]));
    } else {
      arg3 = *(reinterpret_cast< __LONG64 * >(argp3));
    }
  }
  (arg1)->add(arg2,arg3);
  return Qnil;
...
SWIGINTERN VALUE
_wrap_BSONObj_add__SWIG_4(int argc, VALUE *argv, VALUE self) {
  BSONObj *arg1 = (BSONObj *) 0 ;
  std::string arg2 ;
  std::string arg3 ;
  void *argp1 = 0 ;
  ...
  }
  {
    ...
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), Ruby_Format_TypeError( "", "std::string","add", 3, argv[1] )); 
    }
    arg3 = *ptr;
    if (SWIG_IsNewObj(res)) delete ptr;
  }
...
SWIGINTERN VALUE
_wrap_BSONObj_add__SWIG_5(int argc, VALUE *argv, VALUE self) {
  BSONObj *arg1 = (BSONObj *) 0 ;
  std::string arg2 ;
  BSONObj *arg3 = 0 ;
  void *argp1 = 0 ;
  ...
  res3 = SWIG_ConvertPtr(argv[1], &argp3, SWIGTYPE_p_BSONObj,  0 );
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), Ruby_Format_TypeError( "", "BSONObj const &","add", 3, argv[1] )); 
  }
  if (!argp3) {
    SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "BSONObj const &","add", 3, argv[1])); 
  }
  arg3 = reinterpret_cast< BSONObj * >(argp3);
...
SWIGINTERN VALUE
_wrap_BSONObj_add__SWIG_6(int argc, VALUE *argv, VALUE self) {
  BSONObj *arg1 = (BSONObj *) 0 ;
  std::string arg2 ;
  BSONArrayObj *arg3 = 0 ;
  void *argp1 = 0 ;
  ...
  res3 = SWIG_ConvertPtr(argv[1], &argp3, SWIGTYPE_p_BSONArrayObj,  0 );
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), Ruby_Format_TypeError( "", "BSONArrayObj const &","add", 3, argv[1] )); 
  }
  if (!argp3) {
    SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "BSONArrayObj const &","add", 3, argv[1])); 
  }
  arg3 = reinterpret_cast< BSONArrayObj * >(argp3);
...
SWIGINTERN VALUE _wrap_BSONObj_add(int nargs, VALUE *args, VALUE self) {
  int argc;
  VALUE argv[4];
  int ii;
  ...
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        void *vptr = 0;
        int res = SWIG_ConvertPtr(argv[2], &vptr, SWIGTYPE_p___LONG64, 0);
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_BSONObj_add__SWIG_3(nargs, args, self);
        }
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_BSONObj_add__SWIG_5(nargs, args, self);
        }
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        void *vptr = 0;
        int res = SWIG_ConvertPtr(argv[2], &vptr, SWIGTYPE_p_BSONArrayObj, 0);
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_BSONObj_add__SWIG_6(nargs, args, self);
        }
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          return _wrap_BSONObj_add__SWIG_0(nargs, args, self);
        }
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          return _wrap_BSONObj_add__SWIG_2(nargs, args, self);
        }
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          return _wrap_BSONObj_add__SWIG_1(nargs, args, self);
        }
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_BSONObj_add__SWIG_4(nargs, args, self);
        }
      }
    }
  }
...
fail:
  Ruby_Format_OverloadedError( argc, 4, "BSONObj.add", 
    "    void BSONObj.add(std::string, int)\n"
    "    void BSONObj.add(std::string, double)\n"
    "    void BSONObj.add(std::string, long)\n"
    "    void BSONObj.add(std::string, __LONG64)\n"
    "    void BSONObj.add(std::string, std::string)\n"
    "    void BSONObj.add(std::string, BSONObj const &)\n"
    "    void BSONObj.add(std::string, BSONArrayObj const &)\n");
...
SWIGINTERN VALUE
_wrap_BSONObj_has(int argc, VALUE *argv, VALUE self) {
  BSONObj *arg1 = (BSONObj *) 0 ;
  std::string arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_BSONObj, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "BSONObj const *","has", 1, self )); 
  }
  arg1 = reinterpret_cast< BSONObj * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    int res = SWIG_AsPtr_std_string(argv[0], &ptr);
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), Ruby_Format_TypeError( "", "std::string","has", 2, argv[0] )); 
    }
    arg2 = *ptr;
    if (SWIG_IsNewObj(res)) delete ptr;
  }
...
SWIGINTERN VALUE
_wrap_BSONObj_getInt(int argc, VALUE *argv, VALUE self) {
  BSONObj *arg1 = (BSONObj *) 0 ;
  std::string arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_BSONObj, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "BSONObj const *","getInt", 1, self )); 
  }
  arg1 = reinterpret_cast< BSONObj * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    int res = SWIG_AsPtr_std_string(argv[0], &ptr);
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), Ruby_Format_TypeError( "", "std::string","getInt", 2, argv[0] )); 
    }
    arg2 = *ptr;
    if (SWIG_IsNewObj(res)) delete ptr;
  }
...
SWIGINTERN VALUE
_wrap_BSONObj_getDouble(int argc, VALUE *argv, VALUE self) {
  BSONObj *arg1 = (BSONObj *) 0 ;
  std::string arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_BSONObj, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "BSONObj const *","getDouble", 1, self )); 
  }
  arg1 = reinterpret_cast< BSONObj * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    int res = SWIG_AsPtr_std_string(argv[0], &ptr);
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), Ruby_Format_TypeError( "", "std::string","getDouble", 2, argv[0] )); 
    }
    arg2 = *ptr;
    if (SWIG_IsNewObj(res)) delete ptr;
  }
...
SWIGINTERN VALUE
_wrap_BSONObj_getLong(int argc, VALUE *argv, VALUE self) {
  BSONObj *arg1 = (BSONObj *) 0 ;
  std::string arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_BSONObj, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "BSONObj const *","getLong", 1, self )); 
  }
  arg1 = reinterpret_cast< BSONObj * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    int res = SWIG_AsPtr_std_string(argv[0], &ptr);
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), Ruby_Format_TypeError( "", "std::string","getLong", 2, argv[0] )); 
    }
    arg2 = *ptr;
    if (SWIG_IsNewObj(res)) delete ptr;
  }
...
SWIGINTERN VALUE
_wrap_BSONObj_getLong64(int argc, VALUE *argv, VALUE self) {
  BSONObj *arg1 = (BSONObj *) 0 ;
  std::string arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_BSONObj, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "BSONObj const *","getLong64", 1, self )); 
  }
  arg1 = reinterpret_cast< BSONObj * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    int res = SWIG_AsPtr_std_string(argv[0], &ptr);
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), Ruby_Format_TypeError( "", "std::string","getLong64", 2, argv[0] )); 
    }
    arg2 = *ptr;
    if (SWIG_IsNewObj(res)) delete ptr;
  }
...
SWIGINTERN VALUE
_wrap_BSONObj_getString(int argc, VALUE *argv, VALUE self) {
  BSONObj *arg1 = (BSONObj *) 0 ;
  std::string arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_BSONObj, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "BSONObj const *","getString", 1, self )); 
  }
  arg1 = reinterpret_cast< BSONObj * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    int res = SWIG_AsPtr_std_string(argv[0], &ptr);
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), Ruby_Format_TypeError( "", "std::string","getString", 2, argv[0] )); 
    }
    arg2 = *ptr;
    if (SWIG_IsNewObj(res)) delete ptr;
  }
...
SWIGINTERN VALUE
_wrap_BSONObj_getBSON(int argc, VALUE *argv, VALUE self) {
  BSONObj *arg1 = (BSONObj *) 0 ;
  std::string arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_BSONObj, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "BSONObj const *","getBSON", 1, self )); 
  }
  arg1 = reinterpret_cast< BSONObj * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    int res = SWIG_AsPtr_std_string(argv[0], &ptr);
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), Ruby_Format_TypeError( "", "std::string","getBSON", 2, argv[0] )); 
    }
    arg2 = *ptr;
    if (SWIG_IsNewObj(res)) delete ptr;
  }
...
SWIGINTERN VALUE
_wrap_BSONObj_getBSONArray(int argc, VALUE *argv, VALUE self) {
  BSONObj *arg1 = (BSONObj *) 0 ;
  std::string arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_BSONObj, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "BSONObj const *","getBSONArray", 1, self )); 
  }
  arg1 = reinterpret_cast< BSONObj * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    int res = SWIG_AsPtr_std_string(argv[0], &ptr);
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), Ruby_Format_TypeError( "", "std::string","getBSONArray", 2, argv[0] )); 
    }
    arg2 = *ptr;
    if (SWIG_IsNewObj(res)) delete ptr;
  }
...
SWIGINTERN VALUE
_wrap_BSONObj_get(int argc, VALUE *argv, VALUE self) {
  BSONObj *arg1 = (BSONObj *) 0 ;
  std::string arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_BSONObj, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "BSONObj const *","get", 1, self )); 
  }
  arg1 = reinterpret_cast< BSONObj * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    int res = SWIG_AsPtr_std_string(argv[0], &ptr);
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), Ruby_Format_TypeError( "", "std::string","get", 2, argv[0] )); 
    }
    arg2 = *ptr;
    if (SWIG_IsNewObj(res)) delete ptr;
  }
...
SWIGINTERN VALUE
_wrap_BSONObj_getContent__SWIG_0(int argc, VALUE *argv, VALUE self) {
  BSONObj *arg1 = (BSONObj *) 0 ;
  std::string arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_BSONObj, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "BSONObj const *","getContent", 1, self )); 
  }
  arg1 = reinterpret_cast< BSONObj * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    int res = SWIG_AsPtr_std_string(argv[0], &ptr);
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), Ruby_Format_TypeError( "", "std::string","getContent", 2, argv[0] )); 
    }
    arg2 = *ptr;
    if (SWIG_IsNewObj(res)) delete ptr;
  }
  result = (BSONContent *)((BSONObj const *)arg1)->getContent(arg2);
  vresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_BSONContent, 0 |  0 );
  return vresult;
fail:
  return Qnil;
}
...
SWIGINTERN VALUE
_wrap_BSONObj_getContent__SWIG_1(int argc, VALUE *argv, VALUE self) {
  BSONObj *arg1 = (BSONObj *) 0 ;
  std::string arg2 ;
  BSONTYPE arg3 ;
  void *argp1 = 0 ;
  ...
  {
    res3 = SWIG_ConvertPtr(argv[1], &argp3, SWIGTYPE_p_BSONTYPE,  0 );
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), Ruby_Format_TypeError( "", "BSONTYPE","getContent", 3, argv[1] )); 
    }  
    if (!argp3) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "BSONTYPE","getContent", 3, argv[1]));
    } else {
      arg3 = *(reinterpret_cast< BSONTYPE * >(argp3));
    }
  }
...
SWIGINTERN VALUE _wrap_BSONObj_getContent(int nargs, VALUE *args, VALUE self) {
  int argc;
  VALUE argv[4];
  int ii;
  ...
  if (argc == 2) {
    ...
    if (_v) {
      ...
      _v = SWIG_CheckState(res);
      if (_v) {
        return _wrap_BSONObj_getContent__SWIG_0(nargs, args, self);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        void *vptr = 0;
        int res = SWIG_ConvertPtr(argv[2], &vptr, SWIGTYPE_p_BSONTYPE, 0);
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_BSONObj_getContent__SWIG_1(nargs, args, self);
        }
      }
    }
  }
...
fail:
  Ruby_Format_OverloadedError( argc, 4, "BSONObj.getContent", 
    "    BSONContent * BSONObj.getContent(std::string)\n"
    "    BSONContent * BSONObj.getContent(std::string, BSONTYPE)\n");
...
SWIGINTERN VALUE
_wrap_BSONObj_getXpath(int argc, VALUE *argv, VALUE self) {
  BSONObj *arg1 = (BSONObj *) 0 ;
  std::string *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_BSONObj, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "BSONObj const *","getXpath", 1, self )); 
  }
  arg1 = reinterpret_cast< BSONObj * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    res2 = SWIG_AsPtr_std_string(argv[0], &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "std::string const &","getXpath", 2, argv[0] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::string const &","getXpath", 2, argv[0])); 
    }
    arg2 = ptr;
  }
...
Iterate thru each element in the BSONObj and select those that match a condition.  A block must be provided.
*/
SWIGINTERN VALUE
_wrap_BSONObj_select(int argc, VALUE *argv, VALUE self) {
  BSONObj *arg1 = (BSONObj *) 0 ;
  char *arg2 = (char *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_BSONObj, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "BSONObj const *","select", 1, self )); 
  }
  arg1 = reinterpret_cast< BSONObj * >(argp1);
  res2 = SWIG_AsCharPtrAndSize(argv[0], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
...
SWIGINTERN VALUE
_wrap_BSONObj_type(int argc, VALUE *argv, VALUE self) {
  BSONObj *arg1 = (BSONObj *) 0 ;
  std::string arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_BSONObj, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "BSONObj const *","type", 1, self )); 
  }
  arg1 = reinterpret_cast< BSONObj * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    int res = SWIG_AsPtr_std_string(argv[0], &ptr);
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), Ruby_Format_TypeError( "", "std::string","type", 2, argv[0] )); 
    }
    arg2 = *ptr;
    if (SWIG_IsNewObj(res)) delete ptr;
  }
  result = ((BSONObj const *)arg1)->type(arg2);
  vresult = SWIG_NewPointerObj((new BSONTYPE(static_cast< const BSONTYPE& >(result))), SWIGTYPE_p_BSONTYPE, SWIG_POINTER_OWN |  0 );
  return vresult;
fail:
  return Qnil;
}
...
SWIGINTERN VALUE
_wrap_BSONObj_toChar(int argc, VALUE *argv, VALUE self) {
  BSONObj *arg1 = (BSONObj *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  char *result = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_BSONObj, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "BSONObj const *","toChar", 1, self )); 
  }
  arg1 = reinterpret_cast< BSONObj * >(argp1);
...
Return an iterator to the beginning of the BSONObj.
*/
SWIGINTERN VALUE
_wrap_BSONObj_begin(int argc, VALUE *argv, VALUE self) {
  BSONObj *arg1 = (BSONObj *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_BSONObj, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "BSONObj const *","begin", 1, self )); 
  }
  arg1 = reinterpret_cast< BSONObj * >(argp1);
  result = ((BSONObj const *)arg1)->begin();
  vresult = SWIG_NewPointerObj((new BSONObj::const_iterator(static_cast< const BSONObj::const_iterator& >(result))), SWIGTYPE_p_std__mapT_std__string_BSONContent_p_t__const_iterator, SWIG_POINTER_OWN |  0 );
  return vresult;
fail:
  return Qnil;
}
...
Return an iterator to past the end of the BSONObj.
*/
SWIGINTERN VALUE
_wrap_BSONObj_end(int argc, VALUE *argv, VALUE self) {
  BSONObj *arg1 = (BSONObj *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  BSONObj::const_iterator result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_BSONObj, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "BSONObj const *","end", 1, self )); 
  }
  arg1 = reinterpret_cast< BSONObj * >(argp1);
...
Size or Length of the BSONObj.
*/
SWIGINTERN VALUE
_wrap_BSONObj_length(int argc, VALUE *argv, VALUE self) {
  BSONObj *arg1 = (BSONObj *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_BSONObj, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "BSONObj const *","length", 1, self )); 
  }
  arg1 = reinterpret_cast< BSONObj * >(argp1);
...
*/
SWIGINTERN VALUE
_wrap_BSONObj___eq__(int argc, VALUE *argv, VALUE self) {
  BSONObj *arg1 = (BSONObj *) 0 ;
  BSONObj *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_BSONObj, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "BSONObj const *","operator ==", 1, self )); 
  }
  arg1 = reinterpret_cast< BSONObj * >(argp1);
  res2 = SWIG_ConvertPtr(argv[0], &argp2, SWIGTYPE_p_BSONObj,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "BSONObj const &","operator ==", 2, argv[0] )); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "BSONObj const &","operator ==", 2, argv[0])); 
  }
  arg2 = reinterpret_cast< BSONObj * >(argp2);
  result = (bool)((BSONObj const *)arg1)->operator ==((BSONObj const &)*arg2);
  vresult = SWIG_From_bool(static_cast< bool >(result));
  return vresult;
fail:
  return Qnil;
...
swig_class SwigClassBSONParser;

#ifdef HAVE_RB_DEFINE_ALLOC_FUNC
SWIGINTERN VALUE
_wrap_BSONParser_allocate(VALUE self) {
#else
  SWIGINTERN VALUE
  _wrap_BSONParser_allocate(int argc, VALUE *argv, VALUE self) {
#endif
    
    
    VALUE vresult = SWIG_NewClassInstance(self, SWIGTYPE_p_BSONParser);
#ifndef HAVE_RB_DEFINE_ALLOC_FUNC
    rb_obj_call_init(vresult, argc, argv);
#endif
    return vresult;
...
SWIGINTERN VALUE
_wrap_new_BSONParser(int argc, VALUE *argv, VALUE self) {
  BSONParser *result = 0 ;
...
SWIGINTERN void
free_BSONParser(BSONParser *arg1) {
    delete arg1;
}

SWIGINTERN VALUE
_wrap_BSONParser_parse(int argc, VALUE *argv, VALUE self) {
  std::string *arg1 = 0 ;
  int res1 = SWIG_OLDOBJ ;
  BSONObj *result = 0 ;
  VALUE vresult = Qnil;
  ...
  }
  {
    ...
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::string const &","BSONParser::parse", 1, argv[0] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::string const &","BSONParser::parse", 1, argv[0])); 
    }
    arg1 = ptr;
  }
...
SWIGINTERN VALUE
_wrap_BSONParser_parseArray(int argc, VALUE *argv, VALUE self) {
  std::string *arg1 = 0 ;
  int res1 = SWIG_OLDOBJ ;
  BSONArrayObj *result = 0 ;
  VALUE vresult = Qnil;
  ...
  }
  {
    ...
    res1 = SWIG_AsPtr_std_string(argv[0], &ptr);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::string const &","BSONParser::parseArray", 1, argv[0] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::string const &","BSONParser::parseArray", 1, argv[0])); 
    }
    arg1 = ptr;
  }
...
SWIGINTERN VALUE
_wrap_parseFilterOperator(int argc, VALUE *argv, VALUE self) {
  char *arg1 = (char *) 0 ;
  int res1 ;
  char *buf1 = 0 ;
  int alloc1 = 0 ;
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "char const *","parseFilterOperator", 1, argv[0] ));
  }
...
SWIGINTERN VALUE
_wrap_new_ParseException__SWIG_0(int argc, VALUE *argv, VALUE self) {
  int arg1 ;
  char *arg2 = (char *) 0 ;
  int val1 ;
  int ecode1 = 0 ;
  ...
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), Ruby_Format_TypeError( "", "int","ParseException", 1, argv[0] ));
  } 
  arg1 = static_cast< int >(val1);
  res2 = SWIG_AsCharPtrAndSize(argv[1], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "char const *","ParseException", 2, argv[1] ));
  }
  arg2 = reinterpret_cast< char * >(buf2);
...
#ifdef HAVE_RB_DEFINE_ALLOC_FUNC
SWIGINTERN VALUE
_wrap_ParseException_allocate(VALUE self) {
#else
  SWIGINTERN VALUE
  _wrap_ParseException_allocate(int argc, VALUE *argv, VALUE self) {
#endif
    
    
    VALUE vresult = SWIG_NewClassInstance(self, SWIGTYPE_p_ParseException);
#ifndef HAVE_RB_DEFINE_ALLOC_FUNC
    rb_obj_call_init(vresult, argc, argv);
#endif
    return vresult;
...
SWIGINTERN VALUE
_wrap_new_ParseException__SWIG_1(int argc, VALUE *argv, VALUE self) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "ParseException const &","ParseException", 1, argv[0] )); 
  }
  if (!argp1) {
    SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "ParseException const &","ParseException", 1, argv[0])); 
  }
...
SWIGINTERN VALUE _wrap_new_ParseException(int nargs, VALUE *args, VALUE self) {
  int argc;
  VALUE argv[2];
  int ii;
  ...
  if (argc == 1) {
    int _v;
    void *vptr = 0;
    int res = SWIG_ConvertPtr(argv[0], &vptr, SWIGTYPE_p_ParseException, 0);
    _v = SWIG_CheckState(res);
    if (_v) {
      return _wrap_new_ParseException__SWIG_1(nargs, args, self);
    }
  }
  if (argc == 2) {
    int _v;
    ...
    if (_v) {
      ...
      _v = SWIG_CheckState(res);
      if (_v) {
        return _wrap_new_ParseException__SWIG_0(nargs, args, self);
      }
    }
  }
  
fail:
  Ruby_Format_OverloadedError( argc, 2, "ParseException.new", 
    "    ParseException.new(int code, char const *error)\n"
    "    ParseException.new(ParseException const &orig)\n");
...
SWIGINTERN VALUE
_wrap_ParseException_what(int argc, VALUE *argv, VALUE self) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "ParseException const *","what", 1, self )); 
  }
  arg1 = reinterpret_cast< ParseException * >(argp1);
...
SWIGINTERN VALUE
_wrap_ParseException_errorCode(int argc, VALUE *argv, VALUE self) {
  ParseException *arg1 = (ParseException *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_ParseException, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "ParseException const *","errorCode", 1, self )); 
  }
  arg1 = reinterpret_cast< ParseException * >(argp1);
...
SWIGINTERN VALUE
_wrap_bson_splitSelect(int argc, VALUE *argv, VALUE self) {
  char *arg1 = (char *) 0 ;
  int res1 ;
  char *buf1 = 0 ;
  int alloc1 = 0 ;
  ...
  res1 = SWIG_AsCharPtrAndSize(argv[0], &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "char const *","bson_splitSelect", 1, argv[0] ));
  }
  arg1 = reinterpret_cast< char * >(buf1);
  result = bson_splitSelect((char const *)arg1);
  vresult = SWIG_NewPointerObj((new std::set< std::string >(static_cast< const std::set< std::string >& >(result))), SWIGTYPE_p_std__setT_std__string_t, SWIG_POINTER_OWN |  0 );
  if (alloc1 == SWIG_NEWOBJ) delete[] buf1;
  return vresult;
fail:
  if (alloc1 == SWIG_NEWOBJ) delete[] buf1;
...
SWIGINTERN VALUE
_wrap_bson_subselect(int argc, VALUE *argv, VALUE self) {
  char *arg1 = (char *) 0 ;
  char *arg2 = (char *) 0 ;
  int res1 ;
  char *buf1 = 0 ;
  ...
  res1 = SWIG_AsCharPtrAndSize(argv[0], &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "char const *","bson_subselect", 1, argv[0] ));
  }
  arg1 = reinterpret_cast< char * >(buf1);
  res2 = SWIG_AsCharPtrAndSize(argv[1], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "char const *","bson_subselect", 2, argv[1] ));
  }
  arg2 = reinterpret_cast< char * >(buf2);
...
_wrap_DjondbConnection_insert__SWIG_0(int argc, VALUE *argv, VALUE self) {
  ...
  arg1 = reinterpret_cast< djondb::DjondbConnection * >(argp1);
  {
    ...
    res2 = SWIG_AsPtr_std_string(argv[0], &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "std::string const &","insert", 2, argv[0] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::string const &","insert", 2, argv[0])); 
    }
    arg2 = ptr;
  }
  {
    ...
    res3 = SWIG_AsPtr_std_string(argv[1], &ptr);
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), Ruby_Format_TypeError( "", "std::string const &","insert", 3, argv[1] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::string const &","insert", 3, argv[1])); 
    }
    arg3 = ptr;
  }
  {
    ...
    res4 = SWIG_AsPtr_std_string(argv[2], &ptr);
    if (!SWIG_IsOK(res4)) {
      SWIG_exception_fail(SWIG_ArgError(res4), Ruby_Format_TypeError( "", "std::string const &","insert", 4, argv[2] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::string const &","insert", 4, argv[2])); 
    }
    arg4 = ptr;
  }
...
_wrap_DjondbConnection_insert__SWIG_1(int argc, VALUE *argv, VALUE self) {
  ...
  res4 = SWIG_ConvertPtr(argv[2], &argp4, SWIGTYPE_p_BSONObj,  0 );
  if (!SWIG_IsOK(res4)) {
    SWIG_exception_fail(SWIG_ArgError(res4), Ruby_Format_TypeError( "", "BSONObj const &","insert", 4, argv[2] )); 
  }
  if (!argp4) {
    SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "BSONObj const &","insert", 4, argv[2])); 
  }
  arg4 = reinterpret_cast< BSONObj * >(argp4);
...
_wrap_DjondbConnection_findByKey__SWIG_0(int argc, VALUE *argv, VALUE self) {
  ...
  arg1 = reinterpret_cast< djondb::DjondbConnection * >(argp1);
  {
    ...
    res2 = SWIG_AsPtr_std_string(argv[0], &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "std::string const &","findByKey", 2, argv[0] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::string const &","findByKey", 2, argv[0])); 
    }
    arg2 = ptr;
  }
  {
    ...
    res3 = SWIG_AsPtr_std_string(argv[1], &ptr);
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), Ruby_Format_TypeError( "", "std::string const &","findByKey", 3, argv[1] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::string const &","findByKey", 3, argv[1])); 
    }
    arg3 = ptr;
  }
  {
    ...
    res4 = SWIG_AsPtr_std_string(argv[2], &ptr);
    if (!SWIG_IsOK(res4)) {
      SWIG_exception_fail(SWIG_ArgError(res4), Ruby_Format_TypeError( "", "std::string const &","findByKey", 4, argv[2] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::string const &","findByKey", 4, argv[2])); 
    }
    arg4 = ptr;
  }
  {
    ...
    if (!SWIG_IsOK(res5)) {
      SWIG_exception_fail(SWIG_ArgError(res5), Ruby_Format_TypeError( "", "std::string const &","findByKey", 5, argv[3] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::string const &","findByKey", 5, argv[3])); 
    }
    arg5 = ptr;
  }
...
/*
  ...
  call-seq:
    ...
    find(db, ns, filter) -> BSONObjVectorPtr
...
_wrap_DjondbConnection_find__SWIG_0(int argc, VALUE *argv, VALUE self) {
  ...
  arg1 = reinterpret_cast< djondb::DjondbConnection * >(argp1);
  {
    ...
    res2 = SWIG_AsPtr_std_string(argv[0], &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "std::string const &","find", 2, argv[0] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::string const &","find", 2, argv[0])); 
    }
    arg2 = ptr;
  }
  {
    ...
    res3 = SWIG_AsPtr_std_string(argv[1], &ptr);
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), Ruby_Format_TypeError( "", "std::string const &","find", 3, argv[1] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::string const &","find", 3, argv[1])); 
    }
    arg3 = ptr;
  }
  {
    ...
    res4 = SWIG_AsPtr_std_string(argv[2], &ptr);
    if (!SWIG_IsOK(res4)) {
      SWIG_exception_fail(SWIG_ArgError(res4), Ruby_Format_TypeError( "", "std::string const &","find", 4, argv[2] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::string const &","find", 4, argv[2])); 
    }
    arg4 = ptr;
  }
  {
    ...
    res5 = SWIG_AsPtr_std_string(argv[3], &ptr);
    if (!SWIG_IsOK(res5)) {
      SWIG_exception_fail(SWIG_ArgError(res5), Ruby_Format_TypeError( "", "std::string const &","find", 5, argv[3] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::string const &","find", 5, argv[3])); 
    }
    arg5 = ptr;
  }
  try {
    result = (std::vector< BSONObj *,std::allocator< BSONObj * > > *)(arg1)->find((std::string const &)*arg2,(std::string const &)*arg3,(std::string const &)*arg4,(std::string const &)*arg5);
  }
  catch(ParseException &_e) {
    rb_exc_raise(SWIG_Ruby_ExceptionType(SWIGTYPE_p_ParseException, SWIG_NewPointerObj((new ParseException(static_cast< const ParseException& >(_e))),SWIGTYPE_p_ParseException,SWIG_POINTER_OWN))); SWIG_fail;
  }
...
_wrap_DjondbConnection_find__SWIG_1(int argc, VALUE *argv, VALUE self) {
  ...
  try {
    result = (std::vector< BSONObj *,std::allocator< BSONObj * > > *)(arg1)->find((std::string const &)*arg2,(std::string const &)*arg3,(std::string const &)*arg4);
  }
  catch(ParseException &_e) {
    rb_exc_raise(SWIG_Ruby_ExceptionType(SWIGTYPE_p_ParseException, SWIG_NewPointerObj((new ParseException(static_cast< const ParseException& >(_e))),SWIGTYPE_p_ParseException,SWIG_POINTER_OWN))); SWIG_fail;
  }
...
_wrap_DjondbConnection_update__SWIG_0(int argc, VALUE *argv, VALUE self) {
  ...
  arg1 = reinterpret_cast< djondb::DjondbConnection * >(argp1);
  {
    ...
    res2 = SWIG_AsPtr_std_string(argv[0], &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "std::string const &","update", 2, argv[0] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::string const &","update", 2, argv[0])); 
    }
    arg2 = ptr;
  }
  {
    ...
    res3 = SWIG_AsPtr_std_string(argv[1], &ptr);
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), Ruby_Format_TypeError( "", "std::string const &","update", 3, argv[1] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::string const &","update", 3, argv[1])); 
    }
    arg3 = ptr;
  }
  {
    ...
    res4 = SWIG_AsPtr_std_string(argv[2], &ptr);
    if (!SWIG_IsOK(res4)) {
      SWIG_exception_fail(SWIG_ArgError(res4), Ruby_Format_TypeError( "", "std::string const &","update", 4, argv[2] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::string const &","update", 4, argv[2])); 
    }
    arg4 = ptr;
  }
...
_wrap_DjondbConnection_update__SWIG_1(int argc, VALUE *argv, VALUE self) {
  ...
  res4 = SWIG_ConvertPtr(argv[2], &argp4, SWIGTYPE_p_BSONObj,  0 );
  if (!SWIG_IsOK(res4)) {
    SWIG_exception_fail(SWIG_ArgError(res4), Ruby_Format_TypeError( "", "BSONObj const &","update", 4, argv[2] )); 
  }
  if (!argp4) {
    SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "BSONObj const &","update", 4, argv[2])); 
  }
  arg4 = reinterpret_cast< BSONObj * >(argp4);
...
_wrap_DjondbConnection_dropNamespace(int argc, VALUE *argv, VALUE self) {
  ...
  arg1 = reinterpret_cast< djondb::DjondbConnection * >(argp1);
  {
    ...
    res2 = SWIG_AsPtr_std_string(argv[0], &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "std::string const &","dropNamespace", 2, argv[0] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::string const &","dropNamespace", 2, argv[0])); 
    }
    arg2 = ptr;
  }
  {
    ...
    res3 = SWIG_AsPtr_std_string(argv[1], &ptr);
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), Ruby_Format_TypeError( "", "std::string const &","dropNamespace", 3, argv[1] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::string const &","dropNamespace", 3, argv[1])); 
    }
    arg3 = ptr;
  }
...
_wrap_DjondbConnection_namespaces(int argc, VALUE *argv, VALUE self) {
  ...
  arg1 = reinterpret_cast< djondb::DjondbConnection * >(argp1);
  {
    ...
    res2 = SWIG_AsPtr_std_string(argv[0], &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "std::string const &","namespaces", 2, argv[0] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::string const &","namespaces", 2, argv[0])); 
    }
    arg2 = ptr;
  }
...
swig_class SwigClassConnectionReference;
...
_wrap_ConnectionReference__connection_set(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_djondb__ConnectionReference, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN VALUE
_wrap_ConnectionReference__connection_get(int argc, VALUE *argv, VALUE self) {
  djondb::ConnectionReference *arg1 = (djondb::ConnectionReference *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  djondb::DjondbConnection *result = 0 ;
...
SWIGINTERN VALUE
_wrap_ConnectionReference__references_set(int argc, VALUE *argv, VALUE self) {
  djondb::ConnectionReference *arg1 = (djondb::ConnectionReference *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_djondb__ConnectionReference, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "djondb::ConnectionReference *","_references", 1, self )); 
  }
  arg1 = reinterpret_cast< djondb::ConnectionReference * >(argp1);
  ecode2 = SWIG_AsVal_int(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "int","_references", 2, argv[0] ));
  } 
  arg2 = static_cast< int >(val2);
...
SWIGINTERN VALUE
_wrap_ConnectionReference__references_get(int argc, VALUE *argv, VALUE self) {
  djondb::ConnectionReference *arg1 = (djondb::ConnectionReference *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int result;
...
#ifdef HAVE_RB_DEFINE_ALLOC_FUNC
SWIGINTERN VALUE
_wrap_ConnectionReference_allocate(VALUE self) {
#else
  SWIGINTERN VALUE
  _wrap_ConnectionReference_allocate(int argc, VALUE *argv, VALUE self) {
#endif
    
    
    VALUE vresult = SWIG_NewClassInstance(self, SWIGTYPE_p_djondb__ConnectionReference);
#ifndef HAVE_RB_DEFINE_ALLOC_FUNC
    rb_obj_call_init(vresult, argc, argv);
#endif
    return vresult;
...
SWIGINTERN VALUE
_wrap_new_ConnectionReference(int argc, VALUE *argv, VALUE self) {
...
SWIGINTERN void
free_djondb_ConnectionReference(djondb::ConnectionReference *arg1) {
    delete arg1;
}
...
static void *_p_ParseExceptionTo_p_std__exception(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((std::exception *)  ((ParseException *) x));
}
...
static swig_type_info _swigt__p_std__allocatorT_BSONObj_p_t = {"_p_std__allocatorT_BSONObj_p_t", "std::vector< BSONObj * >::allocator_type *|std::allocator< BSONObj * > *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t = {"_p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t", "std::vector< BSONObj * > *|std::vector< BSONObj *,std::allocator< BSONObj * > > *", 0, 0, (void*)0, 0};
...
static swig_cast_info _swigc__p_std__allocatorT_BSONObj_p_t[] = {  {&_swigt__p_std__allocatorT_BSONObj_p_t, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_std__allocatorT_std__string_t[] = {  {&_swigt__p_std__allocatorT_std__string_t, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_std__exception[] = {  {&_swigt__p_std__exception, 0, 0, 0},  {&_swigt__p_ParseException, _p_ParseExceptionTo_p_std__exception, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t[] = {  {&_swigt__p_std__vectorT_BSONObj_p_std__allocatorT_BSONObj_p_t_t, 0, 0, 0},{0, 0, 0, 0}};
...
SWIGEXPORT void Init_djondb(void) {
  ...
  rb_define_method(SwigClassBSONObjVectorPtr.klass, "dup", VALUEFUNC(_wrap_BSONObjVectorPtr_dup), -1);
  rb_define_method(SwigClassBSONObjVectorPtr.klass, "inspect", VALUEFUNC(_wrap_BSONObjVectorPtr_inspect), -1);
  rb_define_method(SwigClassBSONObjVectorPtr.klass, "to_a", VALUEFUNC(_wrap_BSONObjVectorPtr_to_a), -1);
  rb_define_method(SwigClassBSONObjVectorPtr.klass, "to_s", VALUEFUNC(_wrap_BSONObjVectorPtr_to_s), -1);
  rb_define_method(SwigClassBSONObjVectorPtr.klass, "slice", VALUEFUNC(_wrap_BSONObjVectorPtr_slice), -1);
  rb_define_method(SwigClassBSONObjVectorPtr.klass, "each", VALUEFUNC(_wrap_BSONObjVectorPtr_each), -1);
  rb_define_method(SwigClassBSONObjVectorPtr.klass, "select", VALUEFUNC(_wrap_BSONObjVectorPtr_select), -1);
  rb_define_method(SwigClassBSONObjVectorPtr.klass, "reject!", VALUEFUNC(_wrap_BSONObjVectorPtr_rejectN___), -1);
  rb_define_alias(SwigClassBSONObjVectorPtr.klass, "delete_if", "reject!");
  rb_define_method(SwigClassBSONObjVectorPtr.klass, "delete_at", VALUEFUNC(_wrap_BSONObjVectorPtr_delete_at), -1);
  rb_define_method(SwigClassBSONObjVectorPtr.klass, "__delete2__", VALUEFUNC(_wrap_BSONObjVectorPtr___delete2__), -1);
  rb_define_method(SwigClassBSONObjVectorPtr.klass, "pop", VALUEFUNC(_wrap_BSONObjVectorPtr_pop), -1);
  rb_define_method(SwigClassBSONObjVectorPtr.klass, "push", VALUEFUNC(_wrap_BSONObjVectorPtr_push), -1);
  rb_define_alias(SwigClassBSONObjVectorPtr.klass, "<<", "push");
  rb_define_method(SwigClassBSONObjVectorPtr.klass, "reject", VALUEFUNC(_wrap_BSONObjVectorPtr_reject), -1);
  rb_define_method(SwigClassBSONObjVectorPtr.klass, "at", VALUEFUNC(_wrap_BSONObjVectorPtr_at), -1);
  rb_define_method(SwigClassBSONObjVectorPtr.klass, "[]", VALUEFUNC(_wrap_BSONObjVectorPtr___getitem__), -1);
  rb_define_method(SwigClassBSONObjVectorPtr.klass, "[]=", VALUEFUNC(_wrap_BSONObjVectorPtr___setitem__), -1);
  rb_define_method(SwigClassBSONObjVectorPtr.klass, "shift", VALUEFUNC(_wrap_BSONObjVectorPtr_shift), -1);
  rb_define_method(SwigClassBSONObjVectorPtr.klass, "unshift", VALUEFUNC(_wrap_BSONObjVectorPtr_unshift), -1);
  rb_define_method(SwigClassBSONObjVectorPtr.klass, "empty?", VALUEFUNC(_wrap_BSONObjVectorPtr_emptyq___), -1);
  rb_define_method(SwigClassBSONObjVectorPtr.klass, "size", VALUEFUNC(_wrap_BSONObjVectorPtr_size), -1);
  rb_define_method(SwigClassBSONObjVectorPtr.klass, "clear", VALUEFUNC(_wrap_BSONObjVectorPtr_clear), -1);
  rb_define_method(SwigClassBSONObjVectorPtr.klass, "swap", VALUEFUNC(_wrap_BSONObjVectorPtr_swap), -1);
  rb_define_method(SwigClassBSONObjVectorPtr.klass, "get_allocator", VALUEFUNC(_wrap_BSONObjVectorPtr_get_allocator), -1);
  rb_define_method(SwigClassBSONObjVectorPtr.klass, "begin", VALUEFUNC(_wrap_BSONObjVectorPtr_begin), -1);
  rb_define_method(SwigClassBSONObjVectorPtr.klass, "end", VALUEFUNC(_wrap_BSONObjVectorPtr_end), -1);
  rb_define_method(SwigClassBSONObjVectorPtr.klass, "rbegin", VALUEFUNC(_wrap_BSONObjVectorPtr_rbegin), -1);
  rb_define_method(SwigClassBSONObjVectorPtr.klass, "rend", VALUEFUNC(_wrap_BSONObjVectorPtr_rend), -1);
  rb_define_method(SwigClassBSONObjVectorPtr.klass, "erase", VALUEFUNC(_wrap_BSONObjVectorPtr_erase), -1);
  rb_define_method(SwigClassBSONObjVectorPtr.klass, "front", VALUEFUNC(_wrap_BSONObjVectorPtr_front), -1);
  rb_define_method(SwigClassBSONObjVectorPtr.klass, "back", VALUEFUNC(_wrap_BSONObjVectorPtr_back), -1);
  rb_define_method(SwigClassBSONObjVectorPtr.klass, "assign", VALUEFUNC(_wrap_BSONObjVectorPtr_assign), -1);
  rb_define_method(SwigClassBSONObjVectorPtr.klass, "resize", VALUEFUNC(_wrap_BSONObjVectorPtr_resize), -1);
  rb_define_method(SwigClassBSONObjVectorPtr.klass, "insert", VALUEFUNC(_wrap_BSONObjVectorPtr_insert), -1);
  rb_define_method(SwigClassBSONObjVectorPtr.klass, "reserve", VALUEFUNC(_wrap_BSONObjVectorPtr_reserve), -1);
  rb_define_method(SwigClassBSONObjVectorPtr.klass, "capacity", VALUEFUNC(_wrap_BSONObjVectorPtr_capacity), -1);
  SwigClassBSONObjVectorPtr.mark = 0;
  ...
  rb_define_method(SwigClassBSONArrayObj.klass, "length", VALUEFUNC(_wrap_BSONArrayObj_length), -1);
  rb_define_method(SwigClassBSONArrayObj.klass, "add", VALUEFUNC(_wrap_BSONArrayObj_add), -1);
  rb_define_method(SwigClassBSONArrayObj.klass, "get", VALUEFUNC(_wrap_BSONArrayObj_get), -1);
  rb_define_method(SwigClassBSONArrayObj.klass, "toChar", VALUEFUNC(_wrap_BSONArrayObj_toChar), -1);
  rb_define_method(SwigClassBSONArrayObj.klass, "select", VALUEFUNC(_wrap_BSONArrayObj_select), -1);
  rb_define_method(SwigClassBSONArrayObj.klass, "begin", VALUEFUNC(_wrap_BSONArrayObj_begin), -1);
  rb_define_method(SwigClassBSONArrayObj.klass, "end", VALUEFUNC(_wrap_BSONArrayObj_end), -1);
  SwigClassBSONArrayObj.mark = 0;
  ...
  rb_define_method(SwigClassBSONObj.klass, "add", VALUEFUNC(_wrap_BSONObj_add), -1);
  rb_define_method(SwigClassBSONObj.klass, "has", VALUEFUNC(_wrap_BSONObj_has), -1);
  rb_define_method(SwigClassBSONObj.klass, "getInt", VALUEFUNC(_wrap_BSONObj_getInt), -1);
  rb_define_method(SwigClassBSONObj.klass, "getDouble", VALUEFUNC(_wrap_BSONObj_getDouble), -1);
  rb_define_method(SwigClassBSONObj.klass, "getLong", VALUEFUNC(_wrap_BSONObj_getLong), -1);
  rb_define_method(SwigClassBSONObj.klass, "getLong64", VALUEFUNC(_wrap_BSONObj_getLong64), -1);
  rb_define_method(SwigClassBSONObj.klass, "getString", VALUEFUNC(_wrap_BSONObj_getString), -1);
  rb_define_method(SwigClassBSONObj.klass, "getBSON", VALUEFUNC(_wrap_BSONObj_getBSON), -1);
  rb_define_method(SwigClassBSONObj.klass, "getBSONArray", VALUEFUNC(_wrap_BSONObj_getBSONArray), -1);
  rb_define_method(SwigClassBSONObj.klass, "get", VALUEFUNC(_wrap_BSONObj_get), -1);
  rb_define_method(SwigClassBSONObj.klass, "getContent", VALUEFUNC(_wrap_BSONObj_getContent), -1);
  rb_define_method(SwigClassBSONObj.klass, "getXpath", VALUEFUNC(_wrap_BSONObj_getXpath), -1);
  rb_define_method(SwigClassBSONObj.klass, "select", VALUEFUNC(_wrap_BSONObj_select), -1);
  rb_define_method(SwigClassBSONObj.klass, "type", VALUEFUNC(_wrap_BSONObj_type), -1);
  rb_define_method(SwigClassBSONObj.klass, "toChar", VALUEFUNC(_wrap_BSONObj_toChar), -1);
  rb_define_method(SwigClassBSONObj.klass, "begin", VALUEFUNC(_wrap_BSONObj_begin), -1);
  rb_define_method(SwigClassBSONObj.klass, "end", VALUEFUNC(_wrap_BSONObj_end), -1);
  rb_define_method(SwigClassBSONObj.klass, "length", VALUEFUNC(_wrap_BSONObj_length), -1);
  rb_define_method(SwigClassBSONObj.klass, "==", VALUEFUNC(_wrap_BSONObj___eq__), -1);
  SwigClassBSONObj.mark = 0;
  ...
  rb_define_singleton_method(SwigClassBSONParser.klass, "parse", VALUEFUNC(_wrap_BSONParser_parse), -1);
  rb_define_singleton_method(SwigClassBSONParser.klass, "parseArray", VALUEFUNC(_wrap_BSONParser_parseArray), -1);
  ...
  rb_define_method(SwigClassParseException.klass, "what", VALUEFUNC(_wrap_ParseException_what), -1);
  rb_define_method(SwigClassParseException.klass, "errorCode", VALUEFUNC(_wrap_ParseException_errorCode), -1);
  ...
  rb_define_method(SwigClassConnectionReference.klass, "_connection=", VALUEFUNC(_wrap_ConnectionReference__connection_set), -1);
  rb_define_method(SwigClassConnectionReference.klass, "_connection", VALUEFUNC(_wrap_ConnectionReference__connection_get), -1);
  rb_define_method(SwigClassConnectionReference.klass, "_references=", VALUEFUNC(_wrap_ConnectionReference__references_set), -1);
  rb_define_method(SwigClassConnectionReference.klass, "_references", VALUEFUNC(_wrap_ConnectionReference__references_get), -1);
  SwigClassConnectionReference.mark = 0;
