...
#define SWIGTYPE_p_std__mapT_std__string_BSONContent_p_t__const_iterator swig_types[17]
#define SWIGTYPE_p_std__setT_std__string_t swig_types[18]
#define SWIGTYPE_p_std__vectorT_BSONObj_p_t swig_types[19]
#define SWIGTYPE_p_std__vectorT_BSONObj_p_t__iterator swig_types[20]
...
ZEND_NAMED_FUNCTION(_wrap_BSONObj_add__SWIG_3) {
  ...
  {
    if(SWIG_ConvertPtr(*args[2], (void **) &tmp3, SWIGTYPE_p___LONG64, 0) < 0 || tmp3 == NULL) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 3 of BSONObj_add. Expected SWIGTYPE_p___LONG64");
    }
    arg3 = *tmp3;
  }
  (arg1)->add(arg2,arg3);
  ...
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        {
          void *tmp;
          _v = (SWIG_ConvertPtr(*argv[2], (void **)&tmp, SWIGTYPE_p___LONG64, 0) >= 0);
        }
        if (_v) {
...
ZEND_NAMED_FUNCTION(_wrap_BSONObj_getLong) {
  ...
  SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_long, 0);
...
ZEND_NAMED_FUNCTION(_wrap_BSONObj_getLong64) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_BSONObj, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of BSONObj_getLong64. Expected SWIGTYPE_p_BSONObj");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  ...
  SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p___LONG64, 0);
...
ZEND_NAMED_FUNCTION(_wrap_BSONObj_getXpath) {
  ...
  {
    BSONContent * resultobj = new BSONContent((const BSONContent &) result);
    SWIG_SetPointerZval(return_value, (void *)resultobj, SWIGTYPE_p_BSONContent, 1);
  }
...
ZEND_NAMED_FUNCTION(_wrap_Connection_find__SWIG_0) {
  ...
  SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_std__vectorT_BSONObj_p_t, 0);
...
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p___LONG64) {
  /* No destructor for simple type _p___LONG64 */
  efree(rsrc->ptr);
}
...
static zend_function_entry djonwrapper_functions[] = {
 ...
 SWIG_ZEND_NAMED_FE(bsonobj_getlong64,_wrap_BSONObj_getLong64,NULL)
...
le_swig__p___LONG64=zend_register_list_destructors_ex(_wrap_destroy_p___LONG64,NULL,(char *)(SWIGTYPE_p___LONG64->name),module_number);
SWIG_TypeClientData(SWIGTYPE_p___LONG64,&le_swig__p___LONG64);
